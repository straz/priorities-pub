(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))o(c);new MutationObserver(c=>{for(const d of c)if(d.type==="childList")for(const f of d.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&o(f)}).observe(document,{childList:!0,subtree:!0});function l(c){const d={};return c.integrity&&(d.integrity=c.integrity),c.referrerPolicy&&(d.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?d.credentials="include":c.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function o(c){if(c.ep)return;c.ep=!0;const d=l(c);fetch(c.href,d)}})();function A1(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var Bc={exports:{}},Va={};var hm;function w1(){if(hm)return Va;hm=1;var a=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function l(o,c,d){var f=null;if(d!==void 0&&(f=""+d),c.key!==void 0&&(f=""+c.key),"key"in c){d={};for(var h in c)h!=="key"&&(d[h]=c[h])}else d=c;return c=d.ref,{$$typeof:a,type:o,key:f,ref:c!==void 0?c:null,props:d}}return Va.Fragment=i,Va.jsx=l,Va.jsxs=l,Va}var mm;function q1(){return mm||(mm=1,Bc.exports=w1()),Bc.exports}var X=q1(),Oc={exports:{}},re={};var ym;function E1(){if(ym)return re;ym=1;var a=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),l=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),b=Symbol.iterator;function E(w){return w===null||typeof w!="object"?null:(w=b&&w[b]||w["@@iterator"],typeof w=="function"?w:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,B={};function K(w,R,W){this.props=w,this.context=R,this.refs=B,this.updater=W||k}K.prototype.isReactComponent={},K.prototype.setState=function(w,R){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,R,"setState")},K.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function L(){}L.prototype=K.prototype;function H(w,R,W){this.props=w,this.context=R,this.refs=B,this.updater=W||k}var V=H.prototype=new L;V.constructor=H,A(V,K.prototype),V.isPureReactComponent=!0;var $=Array.isArray;function J(){}var z={H:null,A:null,T:null,S:null},U=Object.prototype.hasOwnProperty;function Q(w,R,W){var ee=W.ref;return{$$typeof:a,type:w,key:R,ref:ee!==void 0?ee:null,props:W}}function P(w,R){return Q(w.type,R,w.props)}function F(w){return typeof w=="object"&&w!==null&&w.$$typeof===a}function I(w){var R={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(W){return R[W]})}var pe=/\/+/g;function Be(w,R){return typeof w=="object"&&w!==null&&w.key!=null?I(""+w.key):R.toString(36)}function Me(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(J,J):(w.status="pending",w.then(function(R){w.status==="pending"&&(w.status="fulfilled",w.value=R)},function(R){w.status==="pending"&&(w.status="rejected",w.reason=R)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function x(w,R,W,ee,oe){var le=typeof w;(le==="undefined"||le==="boolean")&&(w=null);var _e=!1;if(w===null)_e=!0;else switch(le){case"bigint":case"string":case"number":_e=!0;break;case"object":switch(w.$$typeof){case a:case i:_e=!0;break;case _:return _e=w._init,x(_e(w._payload),R,W,ee,oe)}}if(_e)return oe=oe(w),_e=ee===""?"."+Be(w,0):ee,$(oe)?(W="",_e!=null&&(W=_e.replace(pe,"$&/")+"/"),x(oe,R,W,"",function(Ae){return Ae})):oe!=null&&(F(oe)&&(oe=P(oe,W+(oe.key==null||w&&w.key===oe.key?"":(""+oe.key).replace(pe,"$&/")+"/")+_e)),R.push(oe)),1;_e=0;var Ue=ee===""?".":ee+":";if($(w))for(var Ee=0;Ee<w.length;Ee++)ee=w[Ee],le=Ue+Be(ee,Ee),_e+=x(ee,R,W,le,oe);else if(Ee=E(w),typeof Ee=="function")for(w=Ee.call(w),Ee=0;!(ee=w.next()).done;)ee=ee.value,le=Ue+Be(ee,Ee++),_e+=x(ee,R,W,le,oe);else if(le==="object"){if(typeof w.then=="function")return x(Me(w),R,W,ee,oe);throw R=String(w),Error("Objects are not valid as a React child (found: "+(R==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":R)+"). If you meant to render a collection of children, use an array instead.")}return _e}function Z(w,R,W){if(w==null)return w;var ee=[],oe=0;return x(w,ee,"","",function(le){return R.call(W,le,oe++)}),ee}function ie(w){if(w._status===-1){var R=w._result;R=R(),R.then(function(W){(w._status===0||w._status===-1)&&(w._status=1,w._result=W)},function(W){(w._status===0||w._status===-1)&&(w._status=2,w._result=W)}),w._status===-1&&(w._status=0,w._result=R)}if(w._status===1)return w._result.default;throw w._result}var de=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var R=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(R))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},ye={map:Z,forEach:function(w,R,W){Z(w,function(){R.apply(this,arguments)},W)},count:function(w){var R=0;return Z(w,function(){R++}),R},toArray:function(w){return Z(w,function(R){return R})||[]},only:function(w){if(!F(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return re.Activity=v,re.Children=ye,re.Component=K,re.Fragment=l,re.Profiler=c,re.PureComponent=H,re.StrictMode=o,re.Suspense=m,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,re.__COMPILER_RUNTIME={__proto__:null,c:function(w){return z.H.useMemoCache(w)}},re.cache=function(w){return function(){return w.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(w,R,W){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var ee=A({},w.props),oe=w.key;if(R!=null)for(le in R.key!==void 0&&(oe=""+R.key),R)!U.call(R,le)||le==="key"||le==="__self"||le==="__source"||le==="ref"&&R.ref===void 0||(ee[le]=R[le]);var le=arguments.length-2;if(le===1)ee.children=W;else if(1<le){for(var _e=Array(le),Ue=0;Ue<le;Ue++)_e[Ue]=arguments[Ue+2];ee.children=_e}return Q(w.type,oe,ee)},re.createContext=function(w){return w={$$typeof:f,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:d,_context:w},w},re.createElement=function(w,R,W){var ee,oe={},le=null;if(R!=null)for(ee in R.key!==void 0&&(le=""+R.key),R)U.call(R,ee)&&ee!=="key"&&ee!=="__self"&&ee!=="__source"&&(oe[ee]=R[ee]);var _e=arguments.length-2;if(_e===1)oe.children=W;else if(1<_e){for(var Ue=Array(_e),Ee=0;Ee<_e;Ee++)Ue[Ee]=arguments[Ee+2];oe.children=Ue}if(w&&w.defaultProps)for(ee in _e=w.defaultProps,_e)oe[ee]===void 0&&(oe[ee]=_e[ee]);return Q(w,le,oe)},re.createRef=function(){return{current:null}},re.forwardRef=function(w){return{$$typeof:h,render:w}},re.isValidElement=F,re.lazy=function(w){return{$$typeof:_,_payload:{_status:-1,_result:w},_init:ie}},re.memo=function(w,R){return{$$typeof:y,type:w,compare:R===void 0?null:R}},re.startTransition=function(w){var R=z.T,W={};z.T=W;try{var ee=w(),oe=z.S;oe!==null&&oe(W,ee),typeof ee=="object"&&ee!==null&&typeof ee.then=="function"&&ee.then(J,de)}catch(le){de(le)}finally{R!==null&&W.types!==null&&(R.types=W.types),z.T=R}},re.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},re.use=function(w){return z.H.use(w)},re.useActionState=function(w,R,W){return z.H.useActionState(w,R,W)},re.useCallback=function(w,R){return z.H.useCallback(w,R)},re.useContext=function(w){return z.H.useContext(w)},re.useDebugValue=function(){},re.useDeferredValue=function(w,R){return z.H.useDeferredValue(w,R)},re.useEffect=function(w,R){return z.H.useEffect(w,R)},re.useEffectEvent=function(w){return z.H.useEffectEvent(w)},re.useId=function(){return z.H.useId()},re.useImperativeHandle=function(w,R,W){return z.H.useImperativeHandle(w,R,W)},re.useInsertionEffect=function(w,R){return z.H.useInsertionEffect(w,R)},re.useLayoutEffect=function(w,R){return z.H.useLayoutEffect(w,R)},re.useMemo=function(w,R){return z.H.useMemo(w,R)},re.useOptimistic=function(w,R){return z.H.useOptimistic(w,R)},re.useReducer=function(w,R,W){return z.H.useReducer(w,R,W)},re.useRef=function(w){return z.H.useRef(w)},re.useState=function(w){return z.H.useState(w)},re.useSyncExternalStore=function(w,R,W){return z.H.useSyncExternalStore(w,R,W)},re.useTransition=function(){return z.H.useTransition()},re.version="19.2.4",re}var gm;function Pc(){return gm||(gm=1,Oc.exports=E1()),Oc.exports}var O=Pc();const Ye=A1(O);var Nc={exports:{}},Za={},Dc={exports:{}},Cc={};var vm;function T1(){return vm||(vm=1,(function(a){function i(x,Z){var ie=x.length;x.push(Z);e:for(;0<ie;){var de=ie-1>>>1,ye=x[de];if(0<c(ye,Z))x[de]=Z,x[ie]=ye,ie=de;else break e}}function l(x){return x.length===0?null:x[0]}function o(x){if(x.length===0)return null;var Z=x[0],ie=x.pop();if(ie!==Z){x[0]=ie;e:for(var de=0,ye=x.length,w=ye>>>1;de<w;){var R=2*(de+1)-1,W=x[R],ee=R+1,oe=x[ee];if(0>c(W,ie))ee<ye&&0>c(oe,W)?(x[de]=oe,x[ee]=ie,de=ee):(x[de]=W,x[R]=ie,de=R);else if(ee<ye&&0>c(oe,ie))x[de]=oe,x[ee]=ie,de=ee;else break e}}return Z}function c(x,Z){var ie=x.sortIndex-Z.sortIndex;return ie!==0?ie:x.id-Z.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var f=Date,h=f.now();a.unstable_now=function(){return f.now()-h}}var m=[],y=[],_=1,v=null,b=3,E=!1,k=!1,A=!1,B=!1,K=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;function V(x){for(var Z=l(y);Z!==null;){if(Z.callback===null)o(y);else if(Z.startTime<=x)o(y),Z.sortIndex=Z.expirationTime,i(m,Z);else break;Z=l(y)}}function $(x){if(A=!1,V(x),!k)if(l(m)!==null)k=!0,J||(J=!0,I());else{var Z=l(y);Z!==null&&Me($,Z.startTime-x)}}var J=!1,z=-1,U=5,Q=-1;function P(){return B?!0:!(a.unstable_now()-Q<U)}function F(){if(B=!1,J){var x=a.unstable_now();Q=x;var Z=!0;try{e:{k=!1,A&&(A=!1,L(z),z=-1),E=!0;var ie=b;try{t:{for(V(x),v=l(m);v!==null&&!(v.expirationTime>x&&P());){var de=v.callback;if(typeof de=="function"){v.callback=null,b=v.priorityLevel;var ye=de(v.expirationTime<=x);if(x=a.unstable_now(),typeof ye=="function"){v.callback=ye,V(x),Z=!0;break t}v===l(m)&&o(m),V(x)}else o(m);v=l(m)}if(v!==null)Z=!0;else{var w=l(y);w!==null&&Me($,w.startTime-x),Z=!1}}break e}finally{v=null,b=ie,E=!1}Z=void 0}}finally{Z?I():J=!1}}}var I;if(typeof H=="function")I=function(){H(F)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,Be=pe.port2;pe.port1.onmessage=F,I=function(){Be.postMessage(null)}}else I=function(){K(F,0)};function Me(x,Z){z=K(function(){x(a.unstable_now())},Z)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(x){x.callback=null},a.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<x?Math.floor(1e3/x):5},a.unstable_getCurrentPriorityLevel=function(){return b},a.unstable_next=function(x){switch(b){case 1:case 2:case 3:var Z=3;break;default:Z=b}var ie=b;b=Z;try{return x()}finally{b=ie}},a.unstable_requestPaint=function(){B=!0},a.unstable_runWithPriority=function(x,Z){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var ie=b;b=x;try{return Z()}finally{b=ie}},a.unstable_scheduleCallback=function(x,Z,ie){var de=a.unstable_now();switch(typeof ie=="object"&&ie!==null?(ie=ie.delay,ie=typeof ie=="number"&&0<ie?de+ie:de):ie=de,x){case 1:var ye=-1;break;case 2:ye=250;break;case 5:ye=1073741823;break;case 4:ye=1e4;break;default:ye=5e3}return ye=ie+ye,x={id:_++,callback:Z,priorityLevel:x,startTime:ie,expirationTime:ye,sortIndex:-1},ie>de?(x.sortIndex=ie,i(y,x),l(m)===null&&x===l(y)&&(A?(L(z),z=-1):A=!0,Me($,ie-de))):(x.sortIndex=ye,i(m,x),k||E||(k=!0,J||(J=!0,I()))),x},a.unstable_shouldYield=P,a.unstable_wrapCallback=function(x){var Z=b;return function(){var ie=b;b=Z;try{return x.apply(this,arguments)}finally{b=ie}}}})(Cc)),Cc}var _m;function B1(){return _m||(_m=1,Dc.exports=T1()),Dc.exports}var xc={exports:{}},yt={};var bm;function O1(){if(bm)return yt;bm=1;var a=Pc();function i(m){var y="https://react.dev/errors/"+m;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)y+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+m+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(){}var o={d:{f:l,r:function(){throw Error(i(522))},D:l,C:l,L:l,m:l,X:l,S:l,M:l},p:0,findDOMNode:null},c=Symbol.for("react.portal");function d(m,y,_){var v=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:c,key:v==null?null:""+v,children:m,containerInfo:y,implementation:_}}var f=a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function h(m,y){if(m==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return yt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=o,yt.createPortal=function(m,y){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(i(299));return d(m,y,null,_)},yt.flushSync=function(m){var y=f.T,_=o.p;try{if(f.T=null,o.p=2,m)return m()}finally{f.T=y,o.p=_,o.d.f()}},yt.preconnect=function(m,y){typeof m=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,o.d.C(m,y))},yt.prefetchDNS=function(m){typeof m=="string"&&o.d.D(m)},yt.preinit=function(m,y){if(typeof m=="string"&&y&&typeof y.as=="string"){var _=y.as,v=h(_,y.crossOrigin),b=typeof y.integrity=="string"?y.integrity:void 0,E=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;_==="style"?o.d.S(m,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:v,integrity:b,fetchPriority:E}):_==="script"&&o.d.X(m,{crossOrigin:v,integrity:b,fetchPriority:E,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},yt.preinitModule=function(m,y){if(typeof m=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var _=h(y.as,y.crossOrigin);o.d.M(m,{crossOrigin:_,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&o.d.M(m)},yt.preload=function(m,y){if(typeof m=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var _=y.as,v=h(_,y.crossOrigin);o.d.L(m,_,{crossOrigin:v,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},yt.preloadModule=function(m,y){if(typeof m=="string")if(y){var _=h(y.as,y.crossOrigin);o.d.m(m,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:_,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else o.d.m(m)},yt.requestFormReset=function(m){o.d.r(m)},yt.unstable_batchedUpdates=function(m,y){return m(y)},yt.useFormState=function(m,y,_){return f.H.useFormState(m,y,_)},yt.useFormStatus=function(){return f.H.useHostTransitionStatus()},yt.version="19.2.4",yt}var Sm;function Im(){if(Sm)return xc.exports;Sm=1;function a(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(a)}catch(i){console.error(i)}}return a(),xc.exports=O1(),xc.exports}var Am;function N1(){if(Am)return Za;Am=1;var a=B1(),i=Pc(),l=Im();function o(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function c(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function d(e){var t=e,n=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(n=t.return),e=t.return;while(e)}return t.tag===3?n:null}function f(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function h(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function m(e){if(d(e)!==e)throw Error(o(188))}function y(e){var t=e.alternate;if(!t){if(t=d(e),t===null)throw Error(o(188));return t!==e?null:e}for(var n=e,s=t;;){var r=n.return;if(r===null)break;var u=r.alternate;if(u===null){if(s=r.return,s!==null){n=s;continue}break}if(r.child===u.child){for(u=r.child;u;){if(u===n)return m(r),e;if(u===s)return m(r),t;u=u.sibling}throw Error(o(188))}if(n.return!==s.return)n=r,s=u;else{for(var p=!1,g=r.child;g;){if(g===n){p=!0,n=r,s=u;break}if(g===s){p=!0,s=r,n=u;break}g=g.sibling}if(!p){for(g=u.child;g;){if(g===n){p=!0,n=u,s=r;break}if(g===s){p=!0,s=u,n=r;break}g=g.sibling}if(!p)throw Error(o(189))}}if(n.alternate!==s)throw Error(o(190))}if(n.tag!==3)throw Error(o(188));return n.stateNode.current===n?e:t}function _(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=_(e),t!==null)return t;e=e.sibling}return null}var v=Object.assign,b=Symbol.for("react.element"),E=Symbol.for("react.transitional.element"),k=Symbol.for("react.portal"),A=Symbol.for("react.fragment"),B=Symbol.for("react.strict_mode"),K=Symbol.for("react.profiler"),L=Symbol.for("react.consumer"),H=Symbol.for("react.context"),V=Symbol.for("react.forward_ref"),$=Symbol.for("react.suspense"),J=Symbol.for("react.suspense_list"),z=Symbol.for("react.memo"),U=Symbol.for("react.lazy"),Q=Symbol.for("react.activity"),P=Symbol.for("react.memo_cache_sentinel"),F=Symbol.iterator;function I(e){return e===null||typeof e!="object"?null:(e=F&&e[F]||e["@@iterator"],typeof e=="function"?e:null)}var pe=Symbol.for("react.client.reference");function Be(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===pe?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case A:return"Fragment";case K:return"Profiler";case B:return"StrictMode";case $:return"Suspense";case J:return"SuspenseList";case Q:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case k:return"Portal";case H:return e.displayName||"Context";case L:return(e._context.displayName||"Context")+".Consumer";case V:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case z:return t=e.displayName||null,t!==null?t:Be(e.type)||"Memo";case U:t=e._payload,e=e._init;try{return Be(e(t))}catch{}}return null}var Me=Array.isArray,x=i.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z=l.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,ie={pending:!1,data:null,method:null,action:null},de=[],ye=-1;function w(e){return{current:e}}function R(e){0>ye||(e.current=de[ye],de[ye]=null,ye--)}function W(e,t){ye++,de[ye]=e.current,e.current=t}var ee=w(null),oe=w(null),le=w(null),_e=w(null);function Ue(e,t){switch(W(le,t),W(oe,e),W(ee,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?jh(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=jh(t),e=Uh(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}R(ee),W(ee,e)}function Ee(){R(ee),R(oe),R(le)}function Ae(e){e.memoizedState!==null&&W(_e,e);var t=ee.current,n=Uh(t,e.type);t!==n&&(W(oe,e),W(ee,n))}function gn(e){oe.current===e&&(R(ee),R(oe)),_e.current===e&&(R(_e),Ga._currentValue=ie)}var At,Bn;function ot(e){if(At===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);At=t&&t[1]||"",Bn=-1<n.stack.indexOf(`
...
`)?$n(l,i):l.includes(`
`)?`
`+$n(l,i):(a.endsWith(" ")?"":" ")+l,sy="flow",Qc="block",Go="quoted";function er(a,i,l="flow",{indentAtStart:o,lineWidth:c=80,minContentWidth:d=20,onFold:f,onOverflow:h}={}){if(!c||c<0)return a;c<d&&(d=0);const m=Math.max(1+d,1+c-i.length);if(a.length<=m)return a;const y=[],_={};let v=c-i.length;typeof o=="number"&&(o>c-Math.max(2,d)?y.push(0):v=c-o);let b,E,k=!1,A=-1,B=-1,K=-1;l===Qc&&(A=qm(a,A,i.length),A!==-1&&(v=A+m));for(let H;H=a[A+=1];){if(l===Go&&H==="\\"){switch(B=A,a[A+1]){case"x":A+=3;break;case"u":A+=5;break;case"U":A+=9;break;default:A+=1}K=A}if(H===`
`)l===Qc&&(A=qm(a,A,i.length)),v=A+i.length+m,b=void 0;else{if(H===" "&&E&&E!==" "&&E!==`
`&&E!=="	"){const V=a[A+1];V&&V!==" "&&V!==`
`&&V!=="	"&&(b=A)}if(A>=v)if(b)y.push(b),v=b+m,b=void 0;else if(l===Go){for(;E===" "||E==="	";)E=H,H=a[A+=1],k=!0;const V=A>K+1?A-2:B-1;if(_[V])return a;y.push(V),_[V]=!0,v=V+m,b=void 0}else k=!0}E=H}if(k&&h&&h(),y.length===0)return a;f&&f();let L=a.slice(0,y[0]);for(let H=0;H<y.length;++H){const V=y[H],$=y[H+1]||a.length;V===0?L=`
${i}${a.slice(0,$)}`:(l===Go&&_[V]&&(L+=`${a[V]}\\`),L+=`
${i}${a.slice(V+1,$)}`)}return L}function qm(a,i,l){let o=i,c=i+1,d=a[c];for(;d===" "||d==="	";)if(i<c+l)d=a[++i];else{do d=a[++i];while(d&&d!==`
...
`&&$!=="	"&&$!==" ")break}let E=l.substring(b);const k=E.indexOf(`
`);k===-1?v="-":l===E||k!==E.length-1?(v="+",d&&d()):v="",E&&(l=l.slice(0,-E.length),E[E.length-1]===`
`&&(E=E.slice(0,-1)),E=E.replace(Zc,`$&${y}`));let A=!1,B,K=-1;for(B=0;B<l.length;++B){const $=l[B];if($===" ")A=!0;else if($===`
`)K=B;else break}let L=l.substring(0,K<B?K+1:B);L&&(l=l.substring(L.length),L=L.replace(/\n+/g,`$&${y}`));let V=(A?y?"2":"1":"")+v;if(a&&(V+=" "+h(a.replace(/ ?[\r\n]+/g," ")),c&&c()),!_){const $=l.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${y}`);let J=!1;const z=tr(o,!0);f!=="folded"&&i!==ue.BLOCK_FOLDED&&(z.onOverflow=()=>{J=!0});const U=er(`${L}${$}${E}`,y,Qc,z);if(!J)return`>${V}
${y}${U}`}return l=l.replace(/\n+/g,`$&${y}`),`|${V}
${y}${L}${l}${E}`}function K1(a,i,l,o){const{type:c,value:d}=a,{actualString:f,implicitKey:h,indent:m,indentStep:y,inFlow:_}=i;if(h&&d.includes(`
...
${f}
${y}
`}};function Zs(a,{flow:i,indicator:l,next:o,offset:c,onError:d,parentIndent:f,startOnNewline:h}){let m=!1,y=h,_=h,v="",b="",E=!1,k=!1,A=null,B=null,K=null,L=null,H=null,V=null,$=null;for(const U of a)switch(k&&(U.type!=="space"&&U.type!=="newline"&&U.type!=="comma"&&d(U.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),k=!1),A&&(y&&U.type!=="comment"&&U.type!=="newline"&&d(A,"TAB_AS_INDENT","Tabs are not allowed as indentation"),A=null),U.type){case"space":!i&&(l!=="doc-start"||o?.type!=="flow-collection")&&U.source.includes("	")&&(A=U),_=!0;break;case"comment":{_||d(U,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const Q=U.source.substring(1)||" ";v?v+=b+Q:v=Q,b="",y=!1;break}case"newline":y?v?v+=U.source:(!V||l!=="seq-item-ind")&&(m=!0):b+=U.source,y=!0,E=!0,(B||K)&&(L=U),_=!0;break;case"anchor":B&&d(U,"MULTIPLE_ANCHORS","A node can have at most one anchor"),U.source.endsWith(":")&&d(U.offset+U.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),B=U,$??($=U.offset),y=!1,_=!1,k=!0;break;case"tag":{K&&d(U,"MULTIPLE_TAGS","A node can have at most one tag"),K=U,$??($=U.offset),y=!1,_=!1,k=!0;break}case l:(B||K)&&d(U,"BAD_PROP_ORDER",`Anchors and tags must be after the ${U.source} indicator`),V&&d(U,"UNEXPECTED_TOKEN",`Unexpected ${U.source} in ${i??"collection"}`),V=U,y=l==="seq-item-ind"||l==="explicit-key-ind",_=!1;break;case"comma":if(i){H&&d(U,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`),H=U,y=!1,_=!1;break}default:d(U,"UNEXPECTED_TOKEN",`Unexpected ${U.type} token`),y=!1,_=!1}const J=a[a.length-1],z=J?J.offset+J.source.length:c;return k&&o&&o.type!=="space"&&o.type!=="newline"&&o.type!=="comma"&&(o.type!=="scalar"||o.source!=="")&&d(o.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),A&&(y&&A.indent<=f||o?.type==="block-map"||o?.type==="block-seq")&&d(A,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:H,found:V,spaceBefore:m,comment:v,hasNewline:E,anchor:B,tag:K,newlineAfterProp:L,end:z,start:$??z}}function sl(a){if(!a)return null;switch(a.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(a.source.includes(`
`))return!0;if(a.end){for(const i of a.end)if(i.type==="newline")return!0}return!1;case"flow-collection":for(const i of a.items){for(const l of i.start)if(l.type==="newline")return!0;if(i.sep){for(const l of i.sep)if(l.type==="newline")return!0}if(sl(i.key)||sl(i.value))return!0}return!1;default:return!0}}function Jc(a,i,l){if(i?.type==="flow-collection"){const o=i.end[0];o.indent===a&&(o.source==="]"||o.source==="}")&&sl(i)&&l(o,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function Ty(a,i,l){const{uniqueKeys:o}=a.options;if(o===!1)return!1;const c=typeof o=="function"?o:(d,f)=>d===f||ze(d)&&ze(f)&&d.value===f.value;return i.some(d=>c(d.key,l))}const Dm="All mapping items must start at the same column";function f_({composeNode:a,composeEmptyNode:i},l,o,c,d){const f=d?.nodeClass??sn,h=new f(l.schema);l.atRoot&&(l.atRoot=!1);let m=o.offset,y=null;for(const _ of o.items){const{start:v,key:b,sep:E,value:k}=_,A=Zs(v,{indicator:"explicit-key-ind",next:b??E?.[0],offset:m,onError:c,parentIndent:o.indent,startOnNewline:!0}),B=!A.found;if(B){if(b&&(b.type==="block-seq"?c(m,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in b&&b.indent!==o.indent&&c(m,"BAD_INDENT",Dm)),!A.anchor&&!A.tag&&!E){y=A.end,A.comment&&(h.comment?h.comment+=`
`+A.comment:h.comment=A.comment);continue}(A.newlineAfterProp||sl(b))&&c(b??v[v.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else A.found?.indent!==o.indent&&c(m,"BAD_INDENT",Dm);l.atKey=!0;const K=A.end,L=b?a(l,b,A,c):i(l,K,v,null,A,c);l.schema.compat&&Jc(o.indent,b,c),l.atKey=!1,Ty(l,h.items,L)&&c(K,"DUPLICATE_KEY","Map keys must be unique");const H=Zs(E??[],{indicator:"map-value-ind",next:k,offset:L.range[2],onError:c,parentIndent:o.indent,startOnNewline:!b||b.type==="block-scalar"});if(m=H.end,H.found){B&&(k?.type==="block-map"&&!H.hasNewline&&c(m,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),l.options.strict&&A.start<H.found.offset-1024&&c(L.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const V=k?a(l,k,H,c):i(l,m,E,null,H,c);l.schema.compat&&Jc(o.indent,k,c),m=V.range[2];const $=new bt(L,V);l.options.keepSourceTokens&&($.srcToken=_),h.items.push($)}else{B&&c(L.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),H.comment&&(L.comment?L.comment+=`
`+H.comment:L.comment=H.comment);const V=new bt(L);l.options.keepSourceTokens&&(V.srcToken=_),h.items.push(V)}}return y&&y<m&&c(y,"IMPOSSIBLE","Map comment with trailing content"),h.range=[o.offset,m,y??m],h}function p_({composeNode:a,composeEmptyNode:i},l,o,c,d){const f=d?.nodeClass??$i,h=new f(l.schema);l.atRoot&&(l.atRoot=!1),l.atKey&&(l.atKey=!1);let m=o.offset,y=null;for(const{start:_,value:v}of o.items){const b=Zs(_,{indicator:"seq-item-ind",next:v,offset:m,onError:c,parentIndent:o.indent,startOnNewline:!0});if(!b.found)if(b.anchor||b.tag||v)v?.type==="block-seq"?c(b.end,"BAD_INDENT","All sequence items must start at the same column"):c(m,"MISSING_CHAR","Sequence item without - indicator");else{y=b.end,b.comment&&(h.comment=b.comment);continue}const E=v?a(l,v,b,c):i(l,b.end,_,null,b,c);l.schema.compat&&Jc(o.indent,v,c),m=E.range[2],h.items.push(E)}return h.range=[o.offset,m,y??m],h}function dl(a,i,l,o){let c="";if(a){let d=!1,f="";for(const h of a){const{source:m,type:y}=h;switch(y){case"space":d=!0;break;case"comment":{l&&!d&&o(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const _=m.substring(1)||" ";c?c+=f+_:c=_,f="";break}case"newline":c&&(f+=m),d=!0;break;default:o(h,"UNEXPECTED_TOKEN",`Unexpected ${y} at node end`)}i+=m.length}}return{comment:c,offset:i}}const zc="Block collections are not allowed within flow collections",Rc=a=>a&&(a.type==="block-map"||a.type==="block-seq");function h_({composeNode:a,composeEmptyNode:i},l,o,c,d){const f=o.start.source==="{",h=f?"flow map":"flow sequence",m=d?.nodeClass??(f?sn:$i),y=new m(l.schema);y.flow=!0;const _=l.atRoot;_&&(l.atRoot=!1),l.atKey&&(l.atKey=!1);let v=o.offset+o.start.source.length;for(let B=0;B<o.items.length;++B){const K=o.items[B],{start:L,key:H,sep:V,value:$}=K,J=Zs(L,{flow:h,indicator:"explicit-key-ind",next:H??V?.[0],offset:v,onError:c,parentIndent:o.indent,startOnNewline:!1});if(!J.found){if(!J.anchor&&!J.tag&&!V&&!$){B===0&&J.comma?c(J.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${h}`):B<o.items.length-1&&c(J.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${h}`),J.comment&&(y.comment?y.comment+=`
`+J.comment:y.comment=J.comment),v=J.end;continue}!f&&l.options.strict&&sl(H)&&c(H,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(B===0)J.comma&&c(J.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${h}`);else if(J.comma||c(J.start,"MISSING_CHAR",`Missing , between ${h} items`),J.comment){let z="";e:for(const U of L)switch(U.type){case"comma":case"space":break;case"comment":z=U.source.substring(1);break e;default:break e}if(z){let U=y.items[y.items.length-1];$e(U)&&(U=U.value??U.key),U.comment?U.comment+=`
`+z:U.comment=z,J.comment=J.comment.substring(z.length+1)}}if(!f&&!V&&!J.found){const z=$?a(l,$,J,c):i(l,J.end,V,null,J,c);y.items.push(z),v=z.range[2],Rc($)&&c(z.range,"BLOCK_IN_FLOW",zc)}else{l.atKey=!0;const z=J.end,U=H?a(l,H,J,c):i(l,z,L,null,J,c);Rc(H)&&c(U.range,"BLOCK_IN_FLOW",zc),l.atKey=!1;const Q=Zs(V??[],{flow:h,indicator:"map-value-ind",next:$,offset:U.range[2],onError:c,parentIndent:o.indent,startOnNewline:!1});if(Q.found){if(!f&&!J.found&&l.options.strict){if(V)for(const I of V){if(I===Q.found)break;if(I.type==="newline"){c(I,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}J.start<Q.found.offset-1024&&c(Q.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else $&&("source"in $&&$.source?.[0]===":"?c($,"MISSING_CHAR",`Missing space after : in ${h}`):c(Q.start,"MISSING_CHAR",`Missing , or : between ${h} items`));const P=$?a(l,$,Q,c):Q.found?i(l,Q.end,V,null,Q,c):null;P?Rc($)&&c(P.range,"BLOCK_IN_FLOW",zc):Q.comment&&(U.comment?U.comment+=`
`+Q.comment:U.comment=Q.comment);const F=new bt(U,P);if(l.options.keepSourceTokens&&(F.srcToken=K),f){const I=y;Ty(l,I.items,U)&&c(z,"DUPLICATE_KEY","Map keys must be unique"),I.items.push(F)}else{const I=new sn(l.schema);I.flow=!0,I.items.push(F);const pe=(P??U).range;I.range=[U.range[0],pe[1],pe[2]],y.items.push(I)}v=P?P.range[2]:Q.end}}const b=f?"}":"]",[E,...k]=o.end;let A=v;if(E?.source===b)A=E.offset+E.source.length;else{const B=h[0].toUpperCase()+h.substring(1),K=_?`${B} must end with a ${b}`:`${B} in block collection must be sufficiently indented and end with a ${b}`;c(v,_?"MISSING_CHAR":"BAD_INDENT",K),E&&E.source.length!==1&&k.unshift(E)}if(k.length>0){const B=dl(k,A,l.options.strict,c);B.comment&&(y.comment?y.comment+=`
`+B.comment:y.comment=B.comment),y.range=[o.offset,A,B.offset]}else y.range=[o.offset,A,A];return y}function jc(a,i,l,o,c,d){const f=l.type==="block-map"?f_(a,i,l,o,d):l.type==="block-seq"?p_(a,i,l,o,d):h_(a,i,l,o,d),h=f.constructor;return c==="!"||c===h.tagName?(f.tag=h.tagName,f):(c&&(f.tag=c),f)}function m_(a,i,l,o,c){const d=o.tag,f=d?i.directives.tagName(d.source,b=>c(d,"TAG_RESOLVE_FAILED",b)):null;if(l.type==="block-seq"){const{anchor:b,newlineAfterProp:E}=o,k=b&&d?b.offset>d.offset?b:d:b??d;k&&(!E||E.offset<k.offset)&&c(k,"MISSING_CHAR","Missing newline after block sequence props")}const h=l.type==="block-map"?"map":l.type==="block-seq"?"seq":l.start.source==="{"?"map":"seq";if(!d||!f||f==="!"||f===sn.tagName&&h==="map"||f===$i.tagName&&h==="seq")return jc(a,i,l,c,f);let m=i.schema.tags.find(b=>b.tag===f&&b.collection===h);if(!m){const b=i.schema.knownTags[f];if(b?.collection===h)i.schema.tags.push(Object.assign({},b,{default:!1})),m=b;else return b?c(d,"BAD_COLLECTION_TYPE",`${b.tag} used for ${h} collection, but expects ${b.collection??"scalar"}`,!0):c(d,"TAG_RESOLVE_FAILED",`Unresolved tag: ${f}`,!0),jc(a,i,l,c,f)}const y=jc(a,i,l,c,f,m),_=m.resolve?.(y,b=>c(d,"TAG_RESOLVE_FAILED",b),i.options)??y,v=Je(_)?_:new ue(_);return v.range=y.range,v.tag=f,m?.format&&(v.format=m.format),v}function y_(a,i,l){const o=i.offset,c=g_(i,a.options.strict,l);if(!c)return{value:"",type:null,comment:"",range:[o,o,o]};const d=c.mode===">"?ue.BLOCK_FOLDED:ue.BLOCK_LITERAL,f=i.source?v_(i.source):[];let h=f.length;for(let A=f.length-1;A>=0;--A){const B=f[A][1];if(B===""||B==="\r")h=A;else break}if(h===0){const A=c.chomp==="+"&&f.length>0?`
`.repeat(Math.max(1,f.length-1)):"";let B=o+c.length;return i.source&&(B+=i.source.length),{value:A,type:d,comment:c.comment,range:[o,B,B]}}let m=i.indent+c.indent,y=i.offset+c.length,_=0;for(let A=0;A<h;++A){const[B,K]=f[A];if(K===""||K==="\r")c.indent===0&&B.length>m&&(m=B.length);else{B.length<m&&l(y+B.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),c.indent===0&&(m=B.length),_=A,m===0&&!a.atRoot&&l(y,"BAD_INDENT","Block scalar values in collections must be indented");break}y+=B.length+K.length+1}for(let A=f.length-1;A>=h;--A)f[A][0].length>m&&(h=A+1);let v="",b="",E=!1;for(let A=0;A<_;++A)v+=f[A][0].slice(m)+`
`;for(let A=_;A<h;++A){let[B,K]=f[A];y+=B.length+K.length+1;const L=K[K.length-1]==="\r";if(L&&(K=K.slice(0,-1)),K&&B.length<m){const V=`Block scalar lines must not be less indented than their ${c.indent?"explicit indentation indicator":"first line"}`;l(y-K.length-(L?2:1),"BAD_INDENT",V),B=""}d===ue.BLOCK_LITERAL?(v+=b+B.slice(m)+K,b=`
`):B.length>m||K[0]==="	"?(b===" "?b=`
`:!E&&b===`
`&&(b=`
...
`&&(v+=`
`);break;default:v+=`
`}const k=o+c.length+i.source.length;return{value:v,type:d,comment:c.comment,range:[o,k,k]}}function g_({offset:a,props:i},l,o){if(i[0].type!=="block-scalar-header")return o(i[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:c}=i[0],d=c[0];let f=0,h="",m=-1;for(let b=1;b<c.length;++b){const E=c[b];if(!h&&(E==="-"||E==="+"))h=E;else{const k=Number(E);!f&&k?f=k:m===-1&&(m=a+b)}}m!==-1&&o(m,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${c}`);let y=!1,_="",v=c.length;for(let b=1;b<i.length;++b){const E=i[b];switch(E.type){case"space":y=!0;case"newline":v+=E.source.length;break;case"comment":l&&!y&&o(E,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),v+=E.source.length,_=E.source.substring(1);break;case"error":o(E,"UNEXPECTED_TOKEN",E.message),v+=E.source.length;break;default:{const k=`Unexpected token in block scalar header: ${E.type}`;o(E,"UNEXPECTED_TOKEN",k);const A=E.source;A&&typeof A=="string"&&(v+=A.length)}}}return{mode:d,indent:f,chomp:h,comment:_,length:v}}function v_(a){const i=a.split(/\n( *)/),l=i[0],o=l.match(/^( *)/),d=[o?.[1]?[o[1],l.slice(o[1].length)]:["",l]];for(let f=1;f<i.length;f+=2)d.push([i[f],i[f+1]]);return d}function __(a,i,l){const{offset:o,type:c,source:d,end:f}=a;let h,m;const y=(b,E,k)=>l(o+b,E,k);switch(c){case"scalar":h=ue.PLAIN,m=b_(d,y);break;case"single-quoted-scalar":h=ue.QUOTE_SINGLE,m=S_(d,y);break;case"double-quoted-scalar":h=ue.QUOTE_DOUBLE,m=A_(d,y);break;default:return l(a,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${c}`),{value:"",type:null,comment:"",range:[o,o+d.length,o+d.length]}}const _=o+d.length,v=dl(f,_,i,l);return{value:m,type:h,comment:v.comment,range:[o,_,v.offset]}}function b_(a,i){let l="";switch(a[0]){case"	":l="a tab character";break;case",":l="flow indicator character ,";break;case"%":l="directive indicator character %";break;case"|":case">":{l=`block scalar indicator ${a[0]}`;break}case"@":case"`":{l=`reserved character ${a[0]}`;break}}return l&&i(0,"BAD_SCALAR_START",`Plain value cannot start with ${l}`),By(a)}function S_(a,i){return(a[a.length-1]!=="'"||a.length===1)&&i(a.length,"MISSING_CHAR","Missing closing 'quote"),By(a.slice(1,-1)).replace(/''/g,"'")}function By(a){let i,l;try{i=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),l=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
...
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function E_(a,i,l,o){const c=a.substr(i,l),f=c.length===l&&/^[0-9a-fA-F]+$/.test(c)?parseInt(c,16):NaN;if(isNaN(f)){const h=a.substr(i-2,l+2);return o(i-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${h}`),h}return String.fromCodePoint(f)}function Oy(a,i,l,o){const{value:c,type:d,comment:f,range:h}=i.type==="block-scalar"?y_(a,i,o):__(i,a.options.strict,o),m=l?a.directives.tagName(l.source,v=>o(l,"TAG_RESOLVE_FAILED",v)):null;let y;a.options.stringKeys&&a.atKey?y=a.schema[Tn]:m?y=T_(a.schema,c,m,l,o):i.type==="scalar"?y=B_(a,c,i,o):y=a.schema[Tn];let _;try{const v=y.resolve(c,b=>o(l??i,"TAG_RESOLVE_FAILED",b),a.options);_=ze(v)?v:new ue(v)}catch(v){const b=v instanceof Error?v.message:String(v);o(l??i,"TAG_RESOLVE_FAILED",b),_=new ue(c)}return _.range=h,_.source=c,d&&(_.type=d),m&&(_.tag=m),y.format&&(_.format=y.format),f&&(_.comment=f),_}function T_(a,i,l,o,c){if(l==="!")return a[Tn];const d=[];for(const h of a.tags)if(!h.collection&&h.tag===l)if(h.default&&h.test)d.push(h);else return h;for(const h of d)if(h.test?.test(i))return h;const f=a.knownTags[l];return f&&!f.collection?(a.tags.push(Object.assign({},f,{default:!1,test:void 0})),f):(c(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${l}`,l!=="tag:yaml.org,2002:str"),a[Tn])}function B_({atKey:a,directives:i,schema:l},o,c,d){const f=l.tags.find(h=>(h.default===!0||a&&h.default==="key")&&h.test?.test(o))||l[Tn];if(l.compat){const h=l.compat.find(m=>m.default&&m.test?.test(o))??l[Tn];if(f.tag!==h.tag){const m=i.tagString(f.tag),y=i.tagString(h.tag),_=`Value may be parsed as either ${m} or ${y}`;d(c,"TAG_RESOLVE_FAILED",_,!0)}}return f}function O_(a,i,l){if(i){l??(l=i.length);for(let o=l-1;o>=0;--o){let c=i[o];switch(c.type){case"space":case"comment":case"newline":a-=c.source.length;continue}for(c=i[++o];c?.type==="space";)a+=c.source.length,c=i[++o];break}}return a}const N_={composeNode:Ny,composeEmptyNode:hd};function Ny(a,i,l,o){const c=a.atKey,{spaceBefore:d,comment:f,anchor:h,tag:m}=l;let y,_=!0;switch(i.type){case"alias":y=D_(a,i,o),(h||m)&&o(i,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":y=Oy(a,i,m,o),h&&(y.anchor=h.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":y=m_(N_,a,i,l,o),h&&(y.anchor=h.source.substring(1));break;default:{const v=i.type==="error"?i.message:`Unsupported token (type: ${i.type})`;o(i,"UNEXPECTED_TOKEN",v),y=hd(a,i.offset,void 0,null,l,o),_=!1}}return h&&y.anchor===""&&o(h,"BAD_ALIAS","Anchor cannot be an empty string"),c&&a.options.stringKeys&&(!ze(y)||typeof y.value!="string"||y.tag&&y.tag!=="tag:yaml.org,2002:str")&&o(m??i,"NON_STRING_KEY","With stringKeys, all keys must be strings"),d&&(y.spaceBefore=!0),f&&(i.type==="scalar"&&i.source===""?y.comment=f:y.commentBefore=f),a.options.keepSourceTokens&&_&&(y.srcToken=i),y}function hd(a,i,l,o,{spaceBefore:c,comment:d,anchor:f,tag:h,end:m},y){const _={type:"scalar",offset:O_(i,l,o),indent:-1,source:""},v=Oy(a,_,h,y);return f&&(v.anchor=f.source.substring(1),v.anchor===""&&y(f,"BAD_ALIAS","Anchor cannot be an empty string")),c&&(v.spaceBefore=!0),d&&(v.comment=d,v.range[2]=m),v}function D_({options:a},{offset:i,source:l,end:o},c){const d=new nd(l.substring(1));d.source===""&&c(i,"BAD_ALIAS","Alias cannot be an empty string"),d.source.endsWith(":")&&c(i+l.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const f=i+l.length,h=dl(o,f,a.strict,c);return d.range=[i,f,h.offset],h.comment&&(d.comment=h.comment),d}function C_(a,i,{offset:l,start:o,value:c,end:d},f){const h=Object.assign({_directives:i},a),m=new rr(void 0,h),y={atKey:!1,atRoot:!0,directives:m.directives,options:m.options,schema:m.schema},_=Zs(o,{indicator:"doc-start",next:c??d?.[0],offset:l,onError:f,parentIndent:0,startOnNewline:!0});_.found&&(m.directives.docStart=!0,c&&(c.type==="block-map"||c.type==="block-seq")&&!_.hasNewline&&f(_.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),m.contents=c?Ny(y,c,_,f):hd(y,_.end,o,null,_,f);const v=m.contents.range[2],b=dl(d,v,!1,f);return b.comment&&(m.comment=b.comment),m.range=[l,v,b.offset],m}function Ja(a){if(typeof a=="number")return[a,a+1];if(Array.isArray(a))return a.length===2?a:[a[0],a[1]];const{offset:i,source:l}=a;return[i,i+(typeof l=="string"?l.length:1)]}function Cm(a){let i="",l=!1,o=!1;for(let c=0;c<a.length;++c){const d=a[c];switch(d[0]){case"#":i+=(i===""?"":o?`
...
`)+1;for(;l!==0;)this.onNewLine(this.offset+l),l=this.source.indexOf(`
`,l)+1}return{type:i,offset:this.offset,indent:this.indent,source:this.source}}startBlockValue(i){switch(this.type){case"alias":case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return this.flowScalar(this.type);case"block-scalar-header":return{type:"block-scalar",offset:this.offset,indent:this.indent,props:[this.sourceToken],source:""};case"flow-map-start":case"flow-seq-start":return{type:"flow-collection",offset:this.offset,indent:this.indent,start:this.sourceToken,items:[],end:[]};case"seq-item-ind":return{type:"block-seq",offset:this.offset,indent:this.indent,items:[{start:[this.sourceToken]}]};case"explicit-key-ind":{this.onKeyLine=!0;const l=Uo(i),o=Ls(l);return o.push(this.sourceToken),{type:"block-map",offset:this.offset,indent:this.indent,items:[{start:o,explicitKey:!0}]}}case"map-value-ind":{this.onKeyLine=!0;const l=Uo(i),o=Ls(l);return{type:"block-map",offset:this.offset,indent:this.indent,items:[{start:o,key:null,sep:[this.sourceToken]}]}}}return null}atIndentedComment(i,l){return this.type!=="comment"||this.indent<=l?!1:i.every(o=>o.type==="newline"||o.type==="space")}*documentEnd(i){this.type!=="doc-mode"&&(i.end?i.end.push(this.sourceToken):i.end=[this.sourceToken],this.type==="newline"&&(yield*this.pop()))}*lineEnd(i){switch(this.type){case"comma":case"doc-start":case"doc-end":case"flow-seq-end":case"flow-map-end":case"map-value-ind":yield*this.pop(),yield*this.step();break;case"newline":this.onKeyLine=!1;default:i.end?i.end.push(this.sourceToken):i.end=[this.sourceToken],this.type==="newline"&&(yield*this.pop())}}}function L_(a){const i=a.prettyErrors!==!1;return{lineCounter:a.lineCounter||i&&new j_||null,prettyErrors:i}}function Y_(a,i={}){const{lineCounter:l,prettyErrors:o}=L_(i),c=new U_(l?.addNewLine),d=new x_(i);let f=null;for(const h of d.compose(c.parse(a),!0,a.length))if(!f)f=h;else if(f.options.logLevel!=="silent"){f.errors.push(new Ia(h.range.slice(0,2),"MULTIPLE_DOCS","Source contains multiple documents; please use YAML.parseAllDocuments()"));break}return o&&l&&(f.errors.forEach(Nm(a,l)),f.warnings.forEach(Nm(a,l))),f}function En(a,i,l){let o;const c=Y_(a,l);if(!c)return null;if(c.warnings.forEach(d=>ly(c.options.logLevel,d)),c.errors.length>0){if(c.options.logLevel!=="silent")throw c.errors[0];c.errors=[]}return c.toJS(Object.assign({reviver:o},l))}var Fa=Im();function H_(){for(var a=arguments.length,i=new Array(a),l=0;l<a;l++)i[l]=arguments[l];return O.useMemo(()=>o=>{i.forEach(c=>c(o))},i)}const ur=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function Ws(a){const i=Object.prototype.toString.call(a);return i==="[object Window]"||i==="[object global]"}function md(a){return"nodeType"in a}function St(a){var i,l;return a?Ws(a)?a:md(a)&&(i=(l=a.ownerDocument)==null?void 0:l.defaultView)!=null?i:window:window}function yd(a){const{Document:i}=St(a);return a instanceof i}function fl(a){return Ws(a)?!1:a instanceof St(a).HTMLElement}function ky(a){return a instanceof St(a).SVGElement}function Ps(a){return a?Ws(a)?a.document:md(a)?yd(a)?a:fl(a)||ky(a)?a.ownerDocument:document:document:document}const hn=ur?O.useLayoutEffect:O.useEffect;function cr(a){const i=O.useRef(a);return hn(()=>{i.current=a}),O.useCallback(function(){for(var l=arguments.length,o=new Array(l),c=0;c<l;c++)o[c]=arguments[c];return i.current==null?void 0:i.current(...o)},[])}function G_(){const a=O.useRef(null),i=O.useCallback((o,c)=>{a.current=setInterval(o,c)},[]),l=O.useCallback(()=>{a.current!==null&&(clearInterval(a.current),a.current=null)},[]);return[i,l]}function al(a,i){i===void 0&&(i=[a]);const l=O.useRef(a);return hn(()=>{l.current!==a&&(l.current=a)},i),l}function pl(a,i){const l=O.useRef();return O.useMemo(()=>{const o=a(l.current);return l.current=o,o},[...i])}function Zo(a){const i=cr(a),l=O.useRef(null),o=O.useCallback(c=>{c!==l.current&&i?.(c,l.current),l.current=c},[]);return[l,o]}function Jo(a){const i=O.useRef();return O.useEffect(()=>{i.current=a},[a]),i.current}let Lc={};function hl(a,i){return O.useMemo(()=>{if(i)return i;const l=Lc[a]==null?0:Lc[a]+1;return Lc[a]=l,a+"-"+l},[a,i])}function zy(a){return function(i){for(var l=arguments.length,o=new Array(l>1?l-1:0),c=1;c<l;c++)o[c-1]=arguments[c];return o.reduce((d,f)=>{const h=Object.entries(f);for(const[m,y]of h){const _=d[m];_!=null&&(d[m]=_+a*y)}return d},{...i})}}const Qs=zy(1),ll=zy(-1);function K_(a){return"clientX"in a&&"clientY"in a}function dr(a){if(!a)return!1;const{KeyboardEvent:i}=St(a.target);return i&&a instanceof i}function X_(a){if(!a)return!1;const{TouchEvent:i}=St(a.target);return i&&a instanceof i}function $o(a){if(X_(a)){if(a.touches&&a.touches.length){const{clientX:i,clientY:l}=a.touches[0];return{x:i,y:l}}else if(a.changedTouches&&a.changedTouches.length){const{clientX:i,clientY:l}=a.changedTouches[0];return{x:i,y:l}}}return K_(a)?{x:a.clientX,y:a.clientY}:null}const Ei=Object.freeze({Translate:{toString(a){if(!a)return;const{x:i,y:l}=a;return"translate3d("+(i?Math.round(i):0)+"px, "+(l?Math.round(l):0)+"px, 0)"}},Scale:{toString(a){if(!a)return;const{scaleX:i,scaleY:l}=a;return"scaleX("+i+") scaleY("+l+")"}},Transform:{toString(a){if(a)return[Ei.Translate.toString(a),Ei.Scale.toString(a)].join(" ")}},Transition:{toString(a){let{property:i,duration:l,easing:o}=a;return i+" "+l+"ms "+o}}}),zm="a,frame,iframe,input:not([type=hidden]):not(:disabled),select:not(:disabled),textarea:not(:disabled),button:not(:disabled),*[tabindex]";function Q_(a){return a.matches(zm)?a:a.querySelector(zm)}const V_={display:"none"};function Z_(a){let{id:i,value:l}=a;return Ye.createElement("div",{id:i,style:V_},l)}function J_(a){let{id:i,announcement:l,ariaLiveType:o="assertive"}=a;const c={position:"fixed",top:0,left:0,width:1,height:1,margin:-1,border:0,padding:0,overflow:"hidden",clip:"rect(0 0 0 0)",clipPath:"inset(100%)",whiteSpace:"nowrap"};return Ye.createElement("div",{id:i,style:c,role:"status","aria-live":o,"aria-atomic":!0},l)}function $_(){const[a,i]=O.useState("");return{announce:O.useCallback(o=>{o!=null&&i(o)},[]),announcement:a}}const Ry=O.createContext(null);function I_(a){const i=O.useContext(Ry);O.useEffect(()=>{if(!i)throw new Error("useDndMonitor must be used within a children of <DndContext>");return i(a)},[a,i])}function F_(){const[a]=O.useState(()=>new Set),i=O.useCallback(o=>(a.add(o),()=>a.delete(o)),[a]);return[O.useCallback(o=>{let{type:c,event:d}=o;a.forEach(f=>{var h;return(h=f[c])==null?void 0:h.call(f,d)})},[a]),i]}const W_={draggable:`
    To pick up a draggable item, press the space bar.
    While dragging, use the arrow keys to move the item.
    Press space again to drop the item in its new position, or press escape to cancel.
  `},P_={onDragStart(a){let{active:i}=a;return"Picked up draggable item "+i.id+"."},onDragOver(a){let{active:i,over:l}=a;return l?"Draggable item "+i.id+" was moved over droppable area "+l.id+".":"Draggable item "+i.id+" is no longer over a droppable area."},onDragEnd(a){let{active:i,over:l}=a;return l?"Draggable item "+i.id+" was dropped over droppable area "+l.id:"Draggable item "+i.id+" was dropped."},onDragCancel(a){let{active:i}=a;return"Dragging was cancelled. Draggable item "+i.id+" was dropped."}};function eb(a){let{announcements:i=P_,container:l,hiddenTextDescribedById:o,screenReaderInstructions:c=W_}=a;const{announce:d,announcement:f}=$_(),h=hl("DndLiveRegion"),[m,y]=O.useState(!1);if(O.useEffect(()=>{y(!0)},[]),I_(O.useMemo(()=>({onDragStart(v){let{active:b}=v;d(i.onDragStart({active:b}))},onDragMove(v){let{active:b,over:E}=v;i.onDragMove&&d(i.onDragMove({active:b,over:E}))},onDragOver(v){let{active:b,over:E}=v;d(i.onDragOver({active:b,over:E}))},onDragEnd(v){let{active:b,over:E}=v;d(i.onDragEnd({active:b,over:E}))},onDragCancel(v){let{active:b,over:E}=v;d(i.onDragCancel({active:b,over:E}))}}),[d,i])),!m)return null;const _=Ye.createElement(Ye.Fragment,null,Ye.createElement(Z_,{id:o,value:c.draggable}),Ye.createElement(J_,{id:h,announcement:f}));return l?Fa.createPortal(_,l):_}var nt;(function(a){a.DragStart="dragStart",a.DragMove="dragMove",a.DragEnd="dragEnd",a.DragCancel="dragCancel",a.DragOver="dragOver",a.RegisterDroppable="registerDroppable",a.SetDroppableDisabled="setDroppableDisabled",a.UnregisterDroppable="unregisterDroppable"})(nt||(nt={}));function Io(){}function Yc(a,i){return O.useMemo(()=>({sensor:a,options:i??{}}),[a,i])}function tb(){for(var a=arguments.length,i=new Array(a),l=0;l<a;l++)i[l]=arguments[l];return O.useMemo(()=>[...i].filter(o=>o!=null),[...i])}const mn=Object.freeze({x:0,y:0});function jy(a,i){return Math.sqrt(Math.pow(a.x-i.x,2)+Math.pow(a.y-i.y,2))}function nb(a,i){const l=$o(a);if(!l)return"0 0";const o={x:(l.x-i.left)/i.width*100,y:(l.y-i.top)/i.height*100};return o.x+"% "+o.y+"%"}function Uy(a,i){let{data:{value:l}}=a,{data:{value:o}}=i;return l-o}function ib(a,i){let{data:{value:l}}=a,{data:{value:o}}=i;return o-l}function Rm(a){let{left:i,top:l,height:o,width:c}=a;return[{x:i,y:l},{x:i+c,y:l},{x:i,y:l+o},{x:i+c,y:l+o}]}function Ly(a,i){if(!a||a.length===0)return null;const[l]=a;return l[i]}function jm(a,i,l){return i===void 0&&(i=a.left),l===void 0&&(l=a.top),{x:i+a.width*.5,y:l+a.height*.5}}const sb=a=>{let{collisionRect:i,droppableRects:l,droppableContainers:o}=a;const c=jm(i,i.left,i.top),d=[];for(const f of o){const{id:h}=f,m=l.get(h);if(m){const y=jy(jm(m),c);d.push({id:h,data:{droppableContainer:f,value:y}})}}return d.sort(Uy)},ab=a=>{let{collisionRect:i,droppableRects:l,droppableContainers:o}=a;const c=Rm(i),d=[];for(const f of o){const{id:h}=f,m=l.get(h);if(m){const y=Rm(m),_=c.reduce((b,E,k)=>b+jy(y[k],E),0),v=Number((_/4).toFixed(4));d.push({id:h,data:{droppableContainer:f,value:v}})}}return d.sort(Uy)};function lb(a,i){const l=Math.max(i.top,a.top),o=Math.max(i.left,a.left),c=Math.min(i.left+i.width,a.left+a.width),d=Math.min(i.top+i.height,a.top+a.height),f=c-o,h=d-l;if(o<c&&l<d){const m=i.width*i.height,y=a.width*a.height,_=f*h,v=_/(m+y-_);return Number(v.toFixed(4))}return 0}const ob=a=>{let{collisionRect:i,droppableRects:l,droppableContainers:o}=a;const c=[];for(const d of o){const{id:f}=d,h=l.get(f);if(h){const m=lb(h,i);m>0&&c.push({id:f,data:{droppableContainer:d,value:m}})}}return c.sort(ib)};function rb(a,i,l){return{...a,scaleX:i&&l?i.width/l.width:1,scaleY:i&&l?i.height/l.height:1}}function Yy(a,i){return a&&i?{x:a.left-i.left,y:a.top-i.top}:mn}function ub(a){return function(l){for(var o=arguments.length,c=new Array(o>1?o-1:0),d=1;d<o;d++)c[d-1]=arguments[d];return c.reduce((f,h)=>({...f,top:f.top+a*h.y,bottom:f.bottom+a*h.y,left:f.left+a*h.x,right:f.right+a*h.x}),{...l})}}const cb=ub(1);function Hy(a){if(a.startsWith("matrix3d(")){const i=a.slice(9,-1).split(/, /);return{x:+i[12],y:+i[13],scaleX:+i[0],scaleY:+i[5]}}else if(a.startsWith("matrix(")){const i=a.slice(7,-1).split(/, /);return{x:+i[4],y:+i[5],scaleX:+i[0],scaleY:+i[3]}}return null}function db(a,i,l){const o=Hy(i);if(!o)return a;const{scaleX:c,scaleY:d,x:f,y:h}=o,m=a.left-f-(1-c)*parseFloat(l),y=a.top-h-(1-d)*parseFloat(l.slice(l.indexOf(" ")+1)),_=c?a.width/c:a.width,v=d?a.height/d:a.height;return{width:_,height:v,top:y,right:m+_,bottom:y+v,left:m}}const fb={ignoreTransform:!1};function ea(a,i){i===void 0&&(i=fb);let l=a.getBoundingClientRect();if(i.ignoreTransform){const{transform:y,transformOrigin:_}=St(a).getComputedStyle(a);y&&(l=db(l,y,_))}const{top:o,left:c,width:d,height:f,bottom:h,right:m}=l;return{top:o,left:c,width:d,height:f,bottom:h,right:m}}function Um(a){return ea(a,{ignoreTransform:!0})}function pb(a){const i=a.innerWidth,l=a.innerHeight;return{top:0,left:0,right:i,bottom:l,width:i,height:l}}function hb(a,i){return i===void 0&&(i=St(a).getComputedStyle(a)),i.position==="fixed"}function mb(a,i){i===void 0&&(i=St(a).getComputedStyle(a));const l=/(auto|scroll|overlay)/;return["overflow","overflowX","overflowY"].some(c=>{const d=i[c];return typeof d=="string"?l.test(d):!1})}function fr(a,i){const l=[];function o(c){if(i!=null&&l.length>=i||!c)return l;if(yd(c)&&c.scrollingElement!=null&&!l.includes(c.scrollingElement))return l.push(c.scrollingElement),l;if(!fl(c)||ky(c)||l.includes(c))return l;const d=St(a).getComputedStyle(c);return c!==a&&mb(c,d)&&l.push(c),hb(c,d)?l:o(c.parentNode)}return a?o(a):l}function Gy(a){const[i]=fr(a,1);return i??null}function Hc(a){return!ur||!a?null:Ws(a)?a:md(a)?yd(a)||a===Ps(a).scrollingElement?window:fl(a)?a:null:null}function Ky(a){return Ws(a)?a.scrollX:a.scrollLeft}function Xy(a){return Ws(a)?a.scrollY:a.scrollTop}function Ic(a){return{x:Ky(a),y:Xy(a)}}var lt;(function(a){a[a.Forward=1]="Forward",a[a.Backward=-1]="Backward"})(lt||(lt={}));function Qy(a){return!ur||!a?!1:a===document.scrollingElement}function Vy(a){const i={x:0,y:0},l=Qy(a)?{height:window.innerHeight,width:window.innerWidth}:{height:a.clientHeight,width:a.clientWidth},o={x:a.scrollWidth-l.width,y:a.scrollHeight-l.height},c=a.scrollTop<=i.y,d=a.scrollLeft<=i.x,f=a.scrollTop>=o.y,h=a.scrollLeft>=o.x;return{isTop:c,isLeft:d,isBottom:f,isRight:h,maxScroll:o,minScroll:i}}const yb={x:.2,y:.2};function gb(a,i,l,o,c){let{top:d,left:f,right:h,bottom:m}=l;o===void 0&&(o=10),c===void 0&&(c=yb);const{isTop:y,isBottom:_,isLeft:v,isRight:b}=Vy(a),E={x:0,y:0},k={x:0,y:0},A={height:i.height*c.y,width:i.width*c.x};return!y&&d<=i.top+A.height?(E.y=lt.Backward,k.y=o*Math.abs((i.top+A.height-d)/A.height)):!_&&m>=i.bottom-A.height&&(E.y=lt.Forward,k.y=o*Math.abs((i.bottom-A.height-m)/A.height)),!b&&h>=i.right-A.width?(E.x=lt.Forward,k.x=o*Math.abs((i.right-A.width-h)/A.width)):!v&&f<=i.left+A.width&&(E.x=lt.Backward,k.x=o*Math.abs((i.left+A.width-f)/A.width)),{direction:E,speed:k}}function vb(a){if(a===document.scrollingElement){const{innerWidth:d,innerHeight:f}=window;return{top:0,left:0,right:d,bottom:f,width:d,height:f}}const{top:i,left:l,right:o,bottom:c}=a.getBoundingClientRect();return{top:i,left:l,right:o,bottom:c,width:a.clientWidth,height:a.clientHeight}}function Zy(a){return a.reduce((i,l)=>Qs(i,Ic(l)),mn)}function _b(a){return a.reduce((i,l)=>i+Ky(l),0)}function bb(a){return a.reduce((i,l)=>i+Xy(l),0)}function Jy(a,i){if(i===void 0&&(i=ea),!a)return;const{top:l,left:o,bottom:c,right:d}=i(a);Gy(a)&&(c<=0||d<=0||l>=window.innerHeight||o>=window.innerWidth)&&a.scrollIntoView({block:"center",inline:"center"})}const Sb=[["x",["left","right"],_b],["y",["top","bottom"],bb]];class gd{constructor(i,l){this.rect=void 0,this.width=void 0,this.height=void 0,this.top=void 0,this.bottom=void 0,this.right=void 0,this.left=void 0;const o=fr(l),c=Zy(o);this.rect={...i},this.width=i.width,this.height=i.height;for(const[d,f,h]of Sb)for(const m of f)Object.defineProperty(this,m,{get:()=>{const y=h(o),_=c[d]-y;return this.rect[m]+_},enumerable:!0});Object.defineProperty(this,"rect",{enumerable:!1})}}class el{constructor(i){this.target=void 0,this.listeners=[],this.removeAll=()=>{this.listeners.forEach(l=>{var o;return(o=this.target)==null?void 0:o.removeEventListener(...l)})},this.target=i}add(i,l,o){var c;(c=this.target)==null||c.addEventListener(i,l,o),this.listeners.push([i,l,o])}}function Ab(a){const{EventTarget:i}=St(a);return a instanceof i?a:Ps(a)}function Gc(a,i){const l=Math.abs(a.x),o=Math.abs(a.y);return typeof i=="number"?Math.sqrt(l**2+o**2)>i:"x"in i&&"y"in i?l>i.x&&o>i.y:"x"in i?l>i.x:"y"in i?o>i.y:!1}var nn;(function(a){a.Click="click",a.DragStart="dragstart",a.Keydown="keydown",a.ContextMenu="contextmenu",a.Resize="resize",a.SelectionChange="selectionchange",a.VisibilityChange="visibilitychange"})(nn||(nn={}));function Lm(a){a.preventDefault()}function wb(a){a.stopPropagation()}var Se;(function(a){a.Space="Space",a.Down="ArrowDown",a.Right="ArrowRight",a.Left="ArrowLeft",a.Up="ArrowUp",a.Esc="Escape",a.Enter="Enter",a.Tab="Tab"})(Se||(Se={}));const $y={start:[Se.Space,Se.Enter],cancel:[Se.Esc],end:[Se.Space,Se.Enter,Se.Tab]},qb=(a,i)=>{let{currentCoordinates:l}=i;switch(a.code){case Se.Right:return{...l,x:l.x+25};case Se.Left:return{...l,x:l.x-25};case Se.Down:return{...l,y:l.y+25};case Se.Up:return{...l,y:l.y-25}}};class vd{constructor(i){this.props=void 0,this.autoScrollEnabled=!1,this.referenceCoordinates=void 0,this.listeners=void 0,this.windowListeners=void 0,this.props=i;const{event:{target:l}}=i;this.props=i,this.listeners=new el(Ps(l)),this.windowListeners=new el(St(l)),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleCancel=this.handleCancel.bind(this),this.attach()}attach(){this.handleStart(),this.windowListeners.add(nn.Resize,this.handleCancel),this.windowListeners.add(nn.VisibilityChange,this.handleCancel),setTimeout(()=>this.listeners.add(nn.Keydown,this.handleKeyDown))}handleStart(){const{activeNode:i,onStart:l}=this.props,o=i.node.current;o&&Jy(o),l(mn)}handleKeyDown(i){if(dr(i)){const{active:l,context:o,options:c}=this.props,{keyboardCodes:d=$y,coordinateGetter:f=qb,scrollBehavior:h="smooth"}=c,{code:m}=i;if(d.end.includes(m)){this.handleEnd(i);return}if(d.cancel.includes(m)){this.handleCancel(i);return}const{collisionRect:y}=o.current,_=y?{x:y.left,y:y.top}:mn;this.referenceCoordinates||(this.referenceCoordinates=_);const v=f(i,{active:l,context:o.current,currentCoordinates:_});if(v){const b=ll(v,_),E={x:0,y:0},{scrollableAncestors:k}=o.current;for(const A of k){const B=i.code,{isTop:K,isRight:L,isLeft:H,isBottom:V,maxScroll:$,minScroll:J}=Vy(A),z=vb(A),U={x:Math.min(B===Se.Right?z.right-z.width/2:z.right,Math.max(B===Se.Right?z.left:z.left+z.width/2,v.x)),y:Math.min(B===Se.Down?z.bottom-z.height/2:z.bottom,Math.max(B===Se.Down?z.top:z.top+z.height/2,v.y))},Q=B===Se.Right&&!L||B===Se.Left&&!H,P=B===Se.Down&&!V||B===Se.Up&&!K;if(Q&&U.x!==v.x){const F=A.scrollLeft+b.x,I=B===Se.Right&&F<=$.x||B===Se.Left&&F>=J.x;if(I&&!b.y){A.scrollTo({left:F,behavior:h});return}I?E.x=A.scrollLeft-F:E.x=B===Se.Right?A.scrollLeft-$.x:A.scrollLeft-J.x,E.x&&A.scrollBy({left:-E.x,behavior:h});break}else if(P&&U.y!==v.y){const F=A.scrollTop+b.y,I=B===Se.Down&&F<=$.y||B===Se.Up&&F>=J.y;if(I&&!b.x){A.scrollTo({top:F,behavior:h});return}I?E.y=A.scrollTop-F:E.y=B===Se.Down?A.scrollTop-$.y:A.scrollTop-J.y,E.y&&A.scrollBy({top:-E.y,behavior:h});break}}this.handleMove(i,Qs(ll(v,this.referenceCoordinates),E))}}}handleMove(i,l){const{onMove:o}=this.props;i.preventDefault(),o(l)}handleEnd(i){const{onEnd:l}=this.props;i.preventDefault(),this.detach(),l()}handleCancel(i){const{onCancel:l}=this.props;i.preventDefault(),this.detach(),l()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll()}}vd.activators=[{eventName:"onKeyDown",handler:(a,i,l)=>{let{keyboardCodes:o=$y,onActivation:c}=i,{active:d}=l;const{code:f}=a.nativeEvent;if(o.start.includes(f)){const h=d.activatorNode.current;return h&&a.target!==h?!1:(a.preventDefault(),c?.({event:a.nativeEvent}),!0)}return!1}}];function Ym(a){return!!(a&&"distance"in a)}function Hm(a){return!!(a&&"delay"in a)}class _d{constructor(i,l,o){var c;o===void 0&&(o=Ab(i.event.target)),this.props=void 0,this.events=void 0,this.autoScrollEnabled=!0,this.document=void 0,this.activated=!1,this.initialCoordinates=void 0,this.timeoutId=null,this.listeners=void 0,this.documentListeners=void 0,this.windowListeners=void 0,this.props=i,this.events=l;const{event:d}=i,{target:f}=d;this.props=i,this.events=l,this.document=Ps(f),this.documentListeners=new el(this.document),this.listeners=new el(o),this.windowListeners=new el(St(f)),this.initialCoordinates=(c=$o(d))!=null?c:mn,this.handleStart=this.handleStart.bind(this),this.handleMove=this.handleMove.bind(this),this.handleEnd=this.handleEnd.bind(this),this.handleCancel=this.handleCancel.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.removeTextSelection=this.removeTextSelection.bind(this),this.attach()}attach(){const{events:i,props:{options:{activationConstraint:l,bypassActivationConstraint:o}}}=this;if(this.listeners.add(i.move.name,this.handleMove,{passive:!1}),this.listeners.add(i.end.name,this.handleEnd),i.cancel&&this.listeners.add(i.cancel.name,this.handleCancel),this.windowListeners.add(nn.Resize,this.handleCancel),this.windowListeners.add(nn.DragStart,Lm),this.windowListeners.add(nn.VisibilityChange,this.handleCancel),this.windowListeners.add(nn.ContextMenu,Lm),this.documentListeners.add(nn.Keydown,this.handleKeydown),l){if(o!=null&&o({event:this.props.event,activeNode:this.props.activeNode,options:this.props.options}))return this.handleStart();if(Hm(l)){this.timeoutId=setTimeout(this.handleStart,l.delay),this.handlePending(l);return}if(Ym(l)){this.handlePending(l);return}}this.handleStart()}detach(){this.listeners.removeAll(),this.windowListeners.removeAll(),setTimeout(this.documentListeners.removeAll,50),this.timeoutId!==null&&(clearTimeout(this.timeoutId),this.timeoutId=null)}handlePending(i,l){const{active:o,onPending:c}=this.props;c(o,i,this.initialCoordinates,l)}handleStart(){const{initialCoordinates:i}=this,{onStart:l}=this.props;i&&(this.activated=!0,this.documentListeners.add(nn.Click,wb,{capture:!0}),this.removeTextSelection(),this.documentListeners.add(nn.SelectionChange,this.removeTextSelection),l(i))}handleMove(i){var l;const{activated:o,initialCoordinates:c,props:d}=this,{onMove:f,options:{activationConstraint:h}}=d;if(!c)return;const m=(l=$o(i))!=null?l:mn,y=ll(c,m);if(!o&&h){if(Ym(h)){if(h.tolerance!=null&&Gc(y,h.tolerance))return this.handleCancel();if(Gc(y,h.distance))return this.handleStart()}if(Hm(h)&&Gc(y,h.tolerance))return this.handleCancel();this.handlePending(h,y);return}i.cancelable&&i.preventDefault(),f(m)}handleEnd(){const{onAbort:i,onEnd:l}=this.props;this.detach(),this.activated||i(this.props.active),l()}handleCancel(){const{onAbort:i,onCancel:l}=this.props;this.detach(),this.activated||i(this.props.active),l()}handleKeydown(i){i.code===Se.Esc&&this.handleCancel()}removeTextSelection(){var i;(i=this.document.getSelection())==null||i.removeAllRanges()}}const Eb={cancel:{name:"pointercancel"},move:{name:"pointermove"},end:{name:"pointerup"}};class bd extends _d{constructor(i){const{event:l}=i,o=Ps(l.target);super(i,Eb,o)}}bd.activators=[{eventName:"onPointerDown",handler:(a,i)=>{let{nativeEvent:l}=a,{onActivation:o}=i;return!l.isPrimary||l.button!==0?!1:(o?.({event:l}),!0)}}];const Tb={move:{name:"mousemove"},end:{name:"mouseup"}};var Fc;(function(a){a[a.RightClick=2]="RightClick"})(Fc||(Fc={}));class Bb extends _d{constructor(i){super(i,Tb,Ps(i.event.target))}}Bb.activators=[{eventName:"onMouseDown",handler:(a,i)=>{let{nativeEvent:l}=a,{onActivation:o}=i;return l.button===Fc.RightClick?!1:(o?.({event:l}),!0)}}];const Kc={cancel:{name:"touchcancel"},move:{name:"touchmove"},end:{name:"touchend"}};class Iy extends _d{constructor(i){super(i,Kc)}static setup(){return window.addEventListener(Kc.move.name,i,{capture:!1,passive:!1}),function(){window.removeEventListener(Kc.move.name,i)};function i(){}}}Iy.activators=[{eventName:"onTouchStart",handler:(a,i)=>{let{nativeEvent:l}=a,{onActivation:o}=i;const{touches:c}=l;return c.length>1?!1:(o?.({event:l}),!0)}}];var tl;(function(a){a[a.Pointer=0]="Pointer",a[a.DraggableRect=1]="DraggableRect"})(tl||(tl={}));var Fo;(function(a){a[a.TreeOrder=0]="TreeOrder",a[a.ReversedTreeOrder=1]="ReversedTreeOrder"})(Fo||(Fo={}));function Ob(a){let{acceleration:i,activator:l=tl.Pointer,canScroll:o,draggingRect:c,enabled:d,interval:f=5,order:h=Fo.TreeOrder,pointerCoordinates:m,scrollableAncestors:y,scrollableAncestorRects:_,delta:v,threshold:b}=a;const E=Db({delta:v,disabled:!d}),[k,A]=G_(),B=O.useRef({x:0,y:0}),K=O.useRef({x:0,y:0}),L=O.useMemo(()=>{switch(l){case tl.Pointer:return m?{top:m.y,bottom:m.y,left:m.x,right:m.x}:null;case tl.DraggableRect:return c}},[l,c,m]),H=O.useRef(null),V=O.useCallback(()=>{const J=H.current;if(!J)return;const z=B.current.x*K.current.x,U=B.current.y*K.current.y;J.scrollBy(z,U)},[]),$=O.useMemo(()=>h===Fo.TreeOrder?[...y].reverse():y,[h,y]);O.useEffect(()=>{if(!d||!y.length||!L){A();return}for(const J of $){if(o?.(J)===!1)continue;const z=y.indexOf(J),U=_[z];if(!U)continue;const{direction:Q,speed:P}=gb(J,U,L,i,b);for(const F of["x","y"])E[F][Q[F]]||(P[F]=0,Q[F]=0);if(P.x>0||P.y>0){A(),H.current=J,k(V,f),B.current=P,K.current=Q;return}}B.current={x:0,y:0},K.current={x:0,y:0},A()},[i,V,o,A,d,f,JSON.stringify(L),JSON.stringify(E),k,y,$,_,JSON.stringify(b)])}const Nb={x:{[lt.Backward]:!1,[lt.Forward]:!1},y:{[lt.Backward]:!1,[lt.Forward]:!1}};function Db(a){let{delta:i,disabled:l}=a;const o=Jo(i);return pl(c=>{if(l||!o||!c)return Nb;const d={x:Math.sign(i.x-o.x),y:Math.sign(i.y-o.y)};return{x:{[lt.Backward]:c.x[lt.Backward]||d.x===-1,[lt.Forward]:c.x[lt.Forward]||d.x===1},y:{[lt.Backward]:c.y[lt.Backward]||d.y===-1,[lt.Forward]:c.y[lt.Forward]||d.y===1}}},[l,i,o])}function Cb(a,i){const l=i!=null?a.get(i):void 0,o=l?l.node.current:null;return pl(c=>{var d;return i==null?null:(d=o??c)!=null?d:null},[o,i])}function xb(a,i){return O.useMemo(()=>a.reduce((l,o)=>{const{sensor:c}=o,d=c.activators.map(f=>({eventName:f.eventName,handler:i(f.handler,o)}));return[...l,...d]},[]),[a,i])}var ol;(function(a){a[a.Always=0]="Always",a[a.BeforeDragging=1]="BeforeDragging",a[a.WhileDragging=2]="WhileDragging"})(ol||(ol={}));var Wc;(function(a){a.Optimized="optimized"})(Wc||(Wc={}));const Gm=new Map;function Mb(a,i){let{dragging:l,dependencies:o,config:c}=i;const[d,f]=O.useState(null),{frequency:h,measure:m,strategy:y}=c,_=O.useRef(a),v=B(),b=al(v),E=O.useCallback(function(K){K===void 0&&(K=[]),!b.current&&f(L=>L===null?K:L.concat(K.filter(H=>!L.includes(H))))},[b]),k=O.useRef(null),A=pl(K=>{if(v&&!l)return Gm;if(!K||K===Gm||_.current!==a||d!=null){const L=new Map;for(let H of a){if(!H)continue;if(d&&d.length>0&&!d.includes(H.id)&&H.rect.current){L.set(H.id,H.rect.current);continue}const V=H.node.current,$=V?new gd(m(V),V):null;H.rect.current=$,$&&L.set(H.id,$)}return L}return K},[a,d,l,v,m]);return O.useEffect(()=>{_.current=a},[a]),O.useEffect(()=>{v||E()},[l,v]),O.useEffect(()=>{d&&d.length>0&&f(null)},[JSON.stringify(d)]),O.useEffect(()=>{v||typeof h!="number"||k.current!==null||(k.current=setTimeout(()=>{E(),k.current=null},h))},[h,v,E,...o]),{droppableRects:A,measureDroppableContainers:E,measuringScheduled:d!=null};function B(){switch(y){case ol.Always:return!1;case ol.BeforeDragging:return l;default:return!l}}}function Sd(a,i){return pl(l=>a?l||(typeof i=="function"?i(a):a):null,[i,a])}function kb(a,i){return Sd(a,i)}function zb(a){let{callback:i,disabled:l}=a;const o=cr(i),c=O.useMemo(()=>{if(l||typeof window>"u"||typeof window.MutationObserver>"u")return;const{MutationObserver:d}=window;return new d(o)},[o,l]);return O.useEffect(()=>()=>c?.disconnect(),[c]),c}function pr(a){let{callback:i,disabled:l}=a;const o=cr(i),c=O.useMemo(()=>{if(l||typeof window>"u"||typeof window.ResizeObserver>"u")return;const{ResizeObserver:d}=window;return new d(o)},[l]);return O.useEffect(()=>()=>c?.disconnect(),[c]),c}function Rb(a){return new gd(ea(a),a)}function Km(a,i,l){i===void 0&&(i=Rb);const[o,c]=O.useState(null);function d(){c(m=>{if(!a)return null;if(a.isConnected===!1){var y;return(y=m??l)!=null?y:null}const _=i(a);return JSON.stringify(m)===JSON.stringify(_)?m:_})}const f=zb({callback(m){if(a)for(const y of m){const{type:_,target:v}=y;if(_==="childList"&&v instanceof HTMLElement&&v.contains(a)){d();break}}}}),h=pr({callback:d});return hn(()=>{d(),a?(h?.observe(a),f?.observe(document.body,{childList:!0,subtree:!0})):(h?.disconnect(),f?.disconnect())},[a]),o}function jb(a){const i=Sd(a);return Yy(a,i)}const Xm=[];function Ub(a){const i=O.useRef(a),l=pl(o=>a?o&&o!==Xm&&a&&i.current&&a.parentNode===i.current.parentNode?o:fr(a):Xm,[a]);return O.useEffect(()=>{i.current=a},[a]),l}function Lb(a){const[i,l]=O.useState(null),o=O.useRef(a),c=O.useCallback(d=>{const f=Hc(d.target);f&&l(h=>h?(h.set(f,Ic(f)),new Map(h)):null)},[]);return O.useEffect(()=>{const d=o.current;if(a!==d){f(d);const h=a.map(m=>{const y=Hc(m);return y?(y.addEventListener("scroll",c,{passive:!0}),[y,Ic(y)]):null}).filter(m=>m!=null);l(h.length?new Map(h):null),o.current=a}return()=>{f(a),f(d)};function f(h){h.forEach(m=>{const y=Hc(m);y?.removeEventListener("scroll",c)})}},[c,a]),O.useMemo(()=>a.length?i?Array.from(i.values()).reduce((d,f)=>Qs(d,f),mn):Zy(a):mn,[a,i])}function Qm(a,i){i===void 0&&(i=[]);const l=O.useRef(null);return O.useEffect(()=>{l.current=null},i),O.useEffect(()=>{const o=a!==mn;o&&!l.current&&(l.current=a),!o&&l.current&&(l.current=null)},[a]),l.current?ll(a,l.current):mn}function Yb(a){O.useEffect(()=>{if(!ur)return;const i=a.map(l=>{let{sensor:o}=l;return o.setup==null?void 0:o.setup()});return()=>{for(const l of i)l?.()}},a.map(i=>{let{sensor:l}=i;return l}))}function Hb(a,i){return O.useMemo(()=>a.reduce((l,o)=>{let{eventName:c,handler:d}=o;return l[c]=f=>{d(f,i)},l},{}),[a,i])}function Fy(a){return O.useMemo(()=>a?pb(a):null,[a])}const Vm=[];function Gb(a,i){i===void 0&&(i=ea);const[l]=a,o=Fy(l?St(l):null),[c,d]=O.useState(Vm);function f(){d(()=>a.length?a.map(m=>Qy(m)?o:new gd(i(m),m)):Vm)}const h=pr({callback:f});return hn(()=>{h?.disconnect(),f(),a.forEach(m=>h?.observe(m))},[a]),c}function Wy(a){if(!a)return null;if(a.children.length>1)return a;const i=a.children[0];return fl(i)?i:a}function Kb(a){let{measure:i}=a;const[l,o]=O.useState(null),c=O.useCallback(y=>{for(const{target:_}of y)if(fl(_)){o(v=>{const b=i(_);return v?{...v,width:b.width,height:b.height}:b});break}},[i]),d=pr({callback:c}),f=O.useCallback(y=>{const _=Wy(y);d?.disconnect(),_&&d?.observe(_),o(_?i(_):null)},[i,d]),[h,m]=Zo(f);return O.useMemo(()=>({nodeRef:h,rect:l,setRef:m}),[l,h,m])}const Xb=[{sensor:bd,options:{}},{sensor:vd,options:{}}],Qb={current:{}},Xo={draggable:{measure:Um},droppable:{measure:Um,strategy:ol.WhileDragging,frequency:Wc.Optimized},dragOverlay:{measure:ea}};class nl extends Map{get(i){var l;return i!=null&&(l=super.get(i))!=null?l:void 0}toArray(){return Array.from(this.values())}getEnabled(){return this.toArray().filter(i=>{let{disabled:l}=i;return!l})}getNodeFor(i){var l,o;return(l=(o=this.get(i))==null?void 0:o.node.current)!=null?l:void 0}}const Vb={activatorEvent:null,active:null,activeNode:null,activeNodeRect:null,collisions:null,containerNodeRect:null,draggableNodes:new Map,droppableRects:new Map,droppableContainers:new nl,over:null,dragOverlay:{nodeRef:{current:null},rect:null,setRef:Io},scrollableAncestors:[],scrollableAncestorRects:[],measuringConfiguration:Xo,measureDroppableContainers:Io,windowRect:null,measuringScheduled:!1},Py={activatorEvent:null,activators:[],active:null,activeNodeRect:null,ariaDescribedById:{draggable:""},dispatch:Io,draggableNodes:new Map,over:null,measureDroppableContainers:Io},ml=O.createContext(Py),eg=O.createContext(Vb);function Zb(){return{draggable:{active:null,initialCoordinates:{x:0,y:0},nodes:new Map,translate:{x:0,y:0}},droppable:{containers:new nl}}}function Jb(a,i){switch(i.type){case nt.DragStart:return{...a,draggable:{...a.draggable,initialCoordinates:i.initialCoordinates,active:i.active}};case nt.DragMove:return a.draggable.active==null?a:{...a,draggable:{...a.draggable,translate:{x:i.coordinates.x-a.draggable.initialCoordinates.x,y:i.coordinates.y-a.draggable.initialCoordinates.y}}};case nt.DragEnd:case nt.DragCancel:return{...a,draggable:{...a.draggable,active:null,initialCoordinates:{x:0,y:0},translate:{x:0,y:0}}};case nt.RegisterDroppable:{const{element:l}=i,{id:o}=l,c=new nl(a.droppable.containers);return c.set(o,l),{...a,droppable:{...a.droppable,containers:c}}}case nt.SetDroppableDisabled:{const{id:l,key:o,disabled:c}=i,d=a.droppable.containers.get(l);if(!d||o!==d.key)return a;const f=new nl(a.droppable.containers);return f.set(l,{...d,disabled:c}),{...a,droppable:{...a.droppable,containers:f}}}case nt.UnregisterDroppable:{const{id:l,key:o}=i,c=a.droppable.containers.get(l);if(!c||o!==c.key)return a;const d=new nl(a.droppable.containers);return d.delete(l),{...a,droppable:{...a.droppable,containers:d}}}default:return a}}function $b(a){let{disabled:i}=a;const{active:l,activatorEvent:o,draggableNodes:c}=O.useContext(ml),d=Jo(o),f=Jo(l?.id);return O.useEffect(()=>{if(!i&&!o&&d&&f!=null){if(!dr(d)||document.activeElement===d.target)return;const h=c.get(f);if(!h)return;const{activatorNode:m,node:y}=h;if(!m.current&&!y.current)return;requestAnimationFrame(()=>{for(const _ of[m.current,y.current]){if(!_)continue;const v=Q_(_);if(v){v.focus();break}}})}},[o,i,c,f,d]),null}function tg(a,i){let{transform:l,...o}=i;return a!=null&&a.length?a.reduce((c,d)=>d({transform:c,...o}),l):l}function Ib(a){return O.useMemo(()=>({draggable:{...Xo.draggable,...a?.draggable},droppable:{...Xo.droppable,...a?.droppable},dragOverlay:{...Xo.dragOverlay,...a?.dragOverlay}}),[a?.draggable,a?.droppable,a?.dragOverlay])}function Fb(a){let{activeNode:i,measure:l,initialRect:o,config:c=!0}=a;const d=O.useRef(!1),{x:f,y:h}=typeof c=="boolean"?{x:c,y:c}:c;hn(()=>{if(!f&&!h||!i){d.current=!1;return}if(d.current||!o)return;const y=i?.node.current;if(!y||y.isConnected===!1)return;const _=l(y),v=Yy(_,o);if(f||(v.x=0),h||(v.y=0),d.current=!0,Math.abs(v.x)>0||Math.abs(v.y)>0){const b=Gy(y);b&&b.scrollBy({top:v.y,left:v.x})}},[i,f,h,o,l])}const hr=O.createContext({...mn,scaleX:1,scaleY:1});var wi;(function(a){a[a.Uninitialized=0]="Uninitialized",a[a.Initializing=1]="Initializing",a[a.Initialized=2]="Initialized"})(wi||(wi={}));const Wb=O.memo(function(i){var l,o,c,d;let{id:f,accessibility:h,autoScroll:m=!0,children:y,sensors:_=Xb,collisionDetection:v=ob,measuring:b,modifiers:E,...k}=i;const A=O.useReducer(Jb,void 0,Zb),[B,K]=A,[L,H]=F_(),[V,$]=O.useState(wi.Uninitialized),J=V===wi.Initialized,{draggable:{active:z,nodes:U,translate:Q},droppable:{containers:P}}=B,F=z!=null?U.get(z):null,I=O.useRef({initial:null,translated:null}),pe=O.useMemo(()=>{var Ke;return z!=null?{id:z,data:(Ke=F?.data)!=null?Ke:Qb,rect:I}:null},[z,F]),Be=O.useRef(null),[Me,x]=O.useState(null),[Z,ie]=O.useState(null),de=al(k,Object.values(k)),ye=hl("DndDescribedBy",f),w=O.useMemo(()=>P.getEnabled(),[P]),R=Ib(b),{droppableRects:W,measureDroppableContainers:ee,measuringScheduled:oe}=Mb(w,{dragging:J,dependencies:[Q.x,Q.y],config:R.droppable}),le=Cb(U,z),_e=O.useMemo(()=>Z?$o(Z):null,[Z]),Ue=Pi(),Ee=kb(le,R.draggable.measure);Fb({activeNode:z!=null?U.get(z):null,config:Ue.layoutShiftCompensation,initialRect:Ee,measure:R.draggable.measure});const Ae=Km(le,R.draggable.measure,Ee),gn=Km(le?le.parentElement:null),At=O.useRef({activatorEvent:null,active:null,activeNode:le,collisionRect:null,collisions:null,droppableRects:W,draggableNodes:U,draggingNode:null,draggingNodeRect:null,droppableContainers:P,over:null,scrollableAncestors:[],scrollAdjustedTranslate:null}),Bn=P.getNodeFor((l=At.current.over)==null?void 0:l.id),ot=Kb({measure:R.dragOverlay.measure}),vn=(o=ot.nodeRef.current)!=null?o:le,_n=J?(c=ot.rect)!=null?c:Ae:null,yl=!!(ot.nodeRef.current&&ot.rect),ta=jb(yl?null:Ae),Ti=Fy(vn?St(vn):null),Ht=Ub(J?Bn??le:null),Fn=Gb(Ht),Fi=tg(E,{transform:{x:Q.x-ta.x,y:Q.y-ta.y,scaleX:1,scaleY:1},activatorEvent:Z,active:pe,activeNodeRect:Ae,containerNodeRect:gn,draggingNodeRect:_n,over:At.current.over,overlayNodeRect:ot.rect,scrollableAncestors:Ht,scrollableAncestorRects:Fn,windowRect:Ti}),gl=_e?Qs(_e,Q):null,pt=Lb(Ht),mr=Qm(pt),vl=Qm(pt,[Ae]),On=Qs(Fi,mr),on=_n?cb(_n,Fi):null,Bi=pe&&on?v({active:pe,collisionRect:on,droppableRects:W,droppableContainers:w,pointerCoordinates:gl}):null,na=Ly(Bi,"id"),[bn,_l]=O.useState(null),Oi=yl?Fi:Qs(Fi,vl),gt=rb(Oi,(d=bn?.rect)!=null?d:null,Ae),Gt=O.useRef(null),ht=O.useCallback((Ke,Xe)=>{let{sensor:it,options:wt}=Xe;if(Be.current==null)return;const qt=U.get(Be.current);if(!qt)return;const mt=Ke.nativeEvent,Et=new it({active:Be.current,activeNode:qt,event:mt,options:wt,context:At,onAbort(et){if(!U.get(et))return;const{onDragAbort:Mt}=de.current,Xt={id:et};Mt?.(Xt),L({type:"onDragAbort",event:Xt})},onPending(et,rn,Mt,Xt){if(!U.get(et))return;const{onDragPending:Dn}=de.current,un={id:et,constraint:rn,initialCoordinates:Mt,offset:Xt};Dn?.(un),L({type:"onDragPending",event:un})},onStart(et){const rn=Be.current;if(rn==null)return;const Mt=U.get(rn);if(!Mt)return;const{onDragStart:Xt}=de.current,Nn={activatorEvent:mt,active:{id:rn,data:Mt.data,rect:I}};Fa.unstable_batchedUpdates(()=>{Xt?.(Nn),$(wi.Initializing),K({type:nt.DragStart,initialCoordinates:et,active:rn}),L({type:"onDragStart",event:Nn}),x(Gt.current),ie(mt)})},onMove(et){K({type:nt.DragMove,coordinates:et})},onEnd:Kt(nt.DragEnd),onCancel:Kt(nt.DragCancel)});Gt.current=Et;function Kt(et){return async function(){const{active:Mt,collisions:Xt,over:Nn,scrollAdjustedTranslate:Dn}=At.current;let un=null;if(Mt&&Dn){const{cancelDrop:Wn}=de.current;un={activatorEvent:mt,active:Mt,collisions:Xt,delta:Dn,over:Nn},et===nt.DragEnd&&typeof Wn=="function"&&await Promise.resolve(Wn(un))&&(et=nt.DragCancel)}Be.current=null,Fa.unstable_batchedUpdates(()=>{K({type:et}),$(wi.Uninitialized),_l(null),x(null),ie(null),Gt.current=null;const Wn=et===nt.DragEnd?"onDragEnd":"onDragCancel";if(un){const Qt=de.current[Wn];Qt?.(un),L({type:Wn,event:un})}})}}},[U]),yr=O.useCallback((Ke,Xe)=>(it,wt)=>{const qt=it.nativeEvent,mt=U.get(wt);if(Be.current!==null||!mt||qt.dndKit||qt.defaultPrevented)return;const Et={active:mt};Ke(it,Xe.options,Et)===!0&&(qt.dndKit={capturedBy:Xe.sensor},Be.current=wt,ht(it,Xe))},[U,ht]),bl=xb(_,yr);Yb(_),hn(()=>{Ae&&V===wi.Initializing&&$(wi.Initialized)},[Ae,V]),O.useEffect(()=>{const{onDragMove:Ke}=de.current,{active:Xe,activatorEvent:it,collisions:wt,over:qt}=At.current;if(!Xe||!it)return;const mt={active:Xe,activatorEvent:it,collisions:wt,delta:{x:On.x,y:On.y},over:qt};Fa.unstable_batchedUpdates(()=>{Ke?.(mt),L({type:"onDragMove",event:mt})})},[On.x,On.y]),O.useEffect(()=>{const{active:Ke,activatorEvent:Xe,collisions:it,droppableContainers:wt,scrollAdjustedTranslate:qt}=At.current;if(!Ke||Be.current==null||!Xe||!qt)return;const{onDragOver:mt}=de.current,Et=wt.get(na),Kt=Et&&Et.rect.current?{id:Et.id,rect:Et.rect.current,data:Et.data,disabled:Et.disabled}:null,et={active:Ke,activatorEvent:Xe,collisions:it,delta:{x:qt.x,y:qt.y},over:Kt};Fa.unstable_batchedUpdates(()=>{_l(Kt),mt?.(et),L({type:"onDragOver",event:et})})},[na]),hn(()=>{At.current={activatorEvent:Z,active:pe,activeNode:le,collisionRect:on,collisions:Bi,droppableRects:W,draggableNodes:U,draggingNode:vn,draggingNodeRect:_n,droppableContainers:P,over:bn,scrollableAncestors:Ht,scrollAdjustedTranslate:On},I.current={initial:_n,translated:on}},[pe,le,Bi,on,U,vn,_n,W,P,bn,Ht,On]),Ob({...Ue,delta:Q,draggingRect:on,pointerCoordinates:gl,scrollableAncestors:Ht,scrollableAncestorRects:Fn});const gr=O.useMemo(()=>({active:pe,activeNode:le,activeNodeRect:Ae,activatorEvent:Z,collisions:Bi,containerNodeRect:gn,dragOverlay:ot,draggableNodes:U,droppableContainers:P,droppableRects:W,over:bn,measureDroppableContainers:ee,scrollableAncestors:Ht,scrollableAncestorRects:Fn,measuringConfiguration:R,measuringScheduled:oe,windowRect:Ti}),[pe,le,Ae,Z,Bi,gn,ot,U,P,W,bn,ee,Ht,Fn,R,oe,Ti]),Wi=O.useMemo(()=>({activatorEvent:Z,activators:bl,active:pe,activeNodeRect:Ae,ariaDescribedById:{draggable:ye},dispatch:K,draggableNodes:U,over:bn,measureDroppableContainers:ee}),[Z,bl,pe,Ae,K,ye,U,bn,ee]);return Ye.createElement(Ry.Provider,{value:H},Ye.createElement(ml.Provider,{value:Wi},Ye.createElement(eg.Provider,{value:gr},Ye.createElement(hr.Provider,{value:gt},y)),Ye.createElement($b,{disabled:h?.restoreFocus===!1})),Ye.createElement(eb,{...h,hiddenTextDescribedById:ye}));function Pi(){const Ke=Me?.autoScrollEnabled===!1,Xe=typeof m=="object"?m.enabled===!1:m===!1,it=J&&!Ke&&!Xe;return typeof m=="object"?{...m,enabled:it}:{enabled:it}}}),Pb=O.createContext(null),Zm="button",e0="Draggable";function t0(a){let{id:i,data:l,disabled:o=!1,attributes:c}=a;const d=hl(e0),{activators:f,activatorEvent:h,active:m,activeNodeRect:y,ariaDescribedById:_,draggableNodes:v,over:b}=O.useContext(ml),{role:E=Zm,roleDescription:k="draggable",tabIndex:A=0}=c??{},B=m?.id===i,K=O.useContext(B?hr:Pb),[L,H]=Zo(),[V,$]=Zo(),J=Hb(f,i),z=al(l);hn(()=>(v.set(i,{id:i,key:d,node:L,activatorNode:V,data:z}),()=>{const Q=v.get(i);Q&&Q.key===d&&v.delete(i)}),[v,i]);const U=O.useMemo(()=>({role:E,tabIndex:A,"aria-disabled":o,"aria-pressed":B&&E===Zm?!0:void 0,"aria-roledescription":k,"aria-describedby":_.draggable}),[o,E,A,B,k,_.draggable]);return{active:m,activatorEvent:h,activeNodeRect:y,attributes:U,isDragging:B,listeners:o?void 0:J,node:L,over:b,setNodeRef:H,setActivatorNodeRef:$,transform:K}}function ng(){return O.useContext(eg)}const n0="Droppable",i0={timeout:25};function s0(a){let{data:i,disabled:l=!1,id:o,resizeObserverConfig:c}=a;const d=hl(n0),{active:f,dispatch:h,over:m,measureDroppableContainers:y}=O.useContext(ml),_=O.useRef({disabled:l}),v=O.useRef(!1),b=O.useRef(null),E=O.useRef(null),{disabled:k,updateMeasurementsFor:A,timeout:B}={...i0,...c},K=al(A??o),L=O.useCallback(()=>{if(!v.current){v.current=!0;return}E.current!=null&&clearTimeout(E.current),E.current=setTimeout(()=>{y(Array.isArray(K.current)?K.current:[K.current]),E.current=null},B)},[B]),H=pr({callback:L,disabled:k||!f}),V=O.useCallback((U,Q)=>{H&&(Q&&(H.unobserve(Q),v.current=!1),U&&H.observe(U))},[H]),[$,J]=Zo(V),z=al(i);return O.useEffect(()=>{!H||!$.current||(H.disconnect(),v.current=!1,H.observe($.current))},[$,H]),O.useEffect(()=>(h({type:nt.RegisterDroppable,element:{id:o,key:d,disabled:l,node:$,rect:b,data:z}}),()=>h({type:nt.UnregisterDroppable,key:d,id:o})),[o]),O.useEffect(()=>{l!==_.current.disabled&&(h({type:nt.SetDroppableDisabled,id:o,key:d,disabled:l}),_.current.disabled=l)},[o,d,l,h]),{active:f,rect:b,isOver:m?.id===o,node:$,over:m,setNodeRef:J}}function a0(a){let{animation:i,children:l}=a;const[o,c]=O.useState(null),[d,f]=O.useState(null),h=Jo(l);return!l&&!o&&h&&c(h),hn(()=>{if(!d)return;const m=o?.key,y=o?.props.id;if(m==null||y==null){c(null);return}Promise.resolve(i(y,d)).then(()=>{c(null)})},[i,o,d]),Ye.createElement(Ye.Fragment,null,l,o?O.cloneElement(o,{ref:f}):null)}const l0={x:0,y:0,scaleX:1,scaleY:1};function o0(a){let{children:i}=a;return Ye.createElement(ml.Provider,{value:Py},Ye.createElement(hr.Provider,{value:l0},i))}const r0={position:"fixed",touchAction:"none"},u0=a=>dr(a)?"transform 250ms ease":void 0,c0=O.forwardRef((a,i)=>{let{as:l,activatorEvent:o,adjustScale:c,children:d,className:f,rect:h,style:m,transform:y,transition:_=u0}=a;if(!h)return null;const v=c?y:{...y,scaleX:1,scaleY:1},b={...r0,width:h.width,height:h.height,top:h.top,left:h.left,transform:Ei.Transform.toString(v),transformOrigin:c&&o?nb(o,h):void 0,transition:typeof _=="function"?_(o):_,...m};return Ye.createElement(l,{className:f,style:b,ref:i},d)}),d0=a=>i=>{let{active:l,dragOverlay:o}=i;const c={},{styles:d,className:f}=a;if(d!=null&&d.active)for(const[h,m]of Object.entries(d.active))m!==void 0&&(c[h]=l.node.style.getPropertyValue(h),l.node.style.setProperty(h,m));if(d!=null&&d.dragOverlay)for(const[h,m]of Object.entries(d.dragOverlay))m!==void 0&&o.node.style.setProperty(h,m);return f!=null&&f.active&&l.node.classList.add(f.active),f!=null&&f.dragOverlay&&o.node.classList.add(f.dragOverlay),function(){for(const[m,y]of Object.entries(c))l.node.style.setProperty(m,y);f!=null&&f.active&&l.node.classList.remove(f.active)}},f0=a=>{let{transform:{initial:i,final:l}}=a;return[{transform:Ei.Transform.toString(i)},{transform:Ei.Transform.toString(l)}]},p0={duration:250,easing:"ease",keyframes:f0,sideEffects:d0({styles:{active:{opacity:"0"}}})};function h0(a){let{config:i,draggableNodes:l,droppableContainers:o,measuringConfiguration:c}=a;return cr((d,f)=>{if(i===null)return;const h=l.get(d);if(!h)return;const m=h.node.current;if(!m)return;const y=Wy(f);if(!y)return;const{transform:_}=St(f).getComputedStyle(f),v=Hy(_);if(!v)return;const b=typeof i=="function"?i:m0(i);return Jy(m,c.draggable.measure),b({active:{id:d,data:h.data,node:m,rect:c.draggable.measure(m)},draggableNodes:l,dragOverlay:{node:f,rect:c.dragOverlay.measure(y)},droppableContainers:o,measuringConfiguration:c,transform:v})})}function m0(a){const{duration:i,easing:l,sideEffects:o,keyframes:c}={...p0,...a};return d=>{let{active:f,dragOverlay:h,transform:m,...y}=d;if(!i)return;const _={x:h.rect.left-f.rect.left,y:h.rect.top-f.rect.top},v={scaleX:m.scaleX!==1?f.rect.width*m.scaleX/h.rect.width:1,scaleY:m.scaleY!==1?f.rect.height*m.scaleY/h.rect.height:1},b={x:m.x-_.x,y:m.y-_.y,...v},E=c({...y,active:f,dragOverlay:h,transform:{initial:m,final:b}}),[k]=E,A=E[E.length-1];if(JSON.stringify(k)===JSON.stringify(A))return;const B=o?.({active:f,dragOverlay:h,...y}),K=h.node.animate(E,{duration:i,easing:l,fill:"forwards"});return new Promise(L=>{K.onfinish=()=>{B?.(),L()}})}}let Jm=0;function y0(a){return O.useMemo(()=>{if(a!=null)return Jm++,Jm},[a])}const g0=Ye.memo(a=>{let{adjustScale:i=!1,children:l,dropAnimation:o,style:c,transition:d,modifiers:f,wrapperElement:h="div",className:m,zIndex:y=999}=a;const{activatorEvent:_,active:v,activeNodeRect:b,containerNodeRect:E,draggableNodes:k,droppableContainers:A,dragOverlay:B,over:K,measuringConfiguration:L,scrollableAncestors:H,scrollableAncestorRects:V,windowRect:$}=ng(),J=O.useContext(hr),z=y0(v?.id),U=tg(f,{activatorEvent:_,active:v,activeNodeRect:b,containerNodeRect:E,draggingNodeRect:B.rect,over:K,overlayNodeRect:B.rect,scrollableAncestors:H,scrollableAncestorRects:V,transform:J,windowRect:$}),Q=Sd(b),P=h0({config:o,draggableNodes:k,droppableContainers:A,measuringConfiguration:L}),F=Q?B.setRef:void 0;return Ye.createElement(o0,null,Ye.createElement(a0,{animation:P},v&&z?Ye.createElement(c0,{key:z,id:v.id,ref:F,as:h,activatorEvent:_,adjustScale:i,className:m,transition:d,rect:Q,style:{zIndex:y,...c},transform:U},l):null))});function Ad(a,i,l){const o=a.slice();return o.splice(l<0?o.length+l:l,0,o.splice(i,1)[0]),o}function v0(a,i){return a.reduce((l,o,c)=>{const d=i.get(o);return d&&(l[c]=d),l},Array(a.length))}function Lo(a){return a!==null&&a>=0}function _0(a,i){if(a===i)return!0;if(a.length!==i.length)return!1;for(let l=0;l<a.length;l++)if(a[l]!==i[l])return!1;return!0}function b0(a){return typeof a=="boolean"?{draggable:a,droppable:a}:a}const ig=a=>{let{rects:i,activeIndex:l,overIndex:o,index:c}=a;const d=Ad(i,o,l),f=i[c],h=d[c];return!h||!f?null:{x:h.left-f.left,y:h.top-f.top,scaleX:h.width/f.width,scaleY:h.height/f.height}},Yo={scaleX:1,scaleY:1},S0=a=>{var i;let{activeIndex:l,activeNodeRect:o,index:c,rects:d,overIndex:f}=a;const h=(i=d[l])!=null?i:o;if(!h)return null;if(c===l){const y=d[f];return y?{x:0,y:l<f?y.top+y.height-(h.top+h.height):y.top-h.top,...Yo}:null}const m=A0(d,c,l);return c>l&&c<=f?{x:0,y:-h.height-m,...Yo}:c<l&&c>=f?{x:0,y:h.height+m,...Yo}:{x:0,y:0,...Yo}};function A0(a,i,l){const o=a[i],c=a[i-1],d=a[i+1];return o?l<i?c?o.top-(c.top+c.height):d?d.top-(o.top+o.height):0:d?d.top-(o.top+o.height):c?o.top-(c.top+c.height):0:0}const sg="Sortable",ag=Ye.createContext({activeIndex:-1,containerId:sg,disableTransforms:!1,items:[],overIndex:-1,useDragOverlay:!1,sortedRects:[],strategy:ig,disabled:{draggable:!1,droppable:!1}});function w0(a){let{children:i,id:l,items:o,strategy:c=ig,disabled:d=!1}=a;const{active:f,dragOverlay:h,droppableRects:m,over:y,measureDroppableContainers:_}=ng(),v=hl(sg,l),b=h.rect!==null,E=O.useMemo(()=>o.map(J=>typeof J=="object"&&"id"in J?J.id:J),[o]),k=f!=null,A=f?E.indexOf(f.id):-1,B=y?E.indexOf(y.id):-1,K=O.useRef(E),L=!_0(E,K.current),H=B!==-1&&A===-1||L,V=b0(d);hn(()=>{L&&k&&_(E)},[L,E,k,_]),O.useEffect(()=>{K.current=E},[E]);const $=O.useMemo(()=>({activeIndex:A,containerId:v,disabled:V,disableTransforms:H,items:E,overIndex:B,useDragOverlay:b,sortedRects:v0(E,m),strategy:c}),[A,v,V.draggable,V.droppable,H,E,B,m,b,c]);return Ye.createElement(ag.Provider,{value:$},i)}const q0=a=>{let{id:i,items:l,activeIndex:o,overIndex:c}=a;return Ad(l,o,c).indexOf(i)},E0=a=>{let{containerId:i,isSorting:l,wasDragging:o,index:c,items:d,newIndex:f,previousItems:h,previousContainerId:m,transition:y}=a;return!y||!o||h!==d&&c===f?!1:l?!0:f!==c&&i===m},T0={duration:200,easing:"ease"},lg="transform",B0=Ei.Transition.toString({property:lg,duration:0,easing:"linear"}),O0={roleDescription:"sortable"};function N0(a){let{disabled:i,index:l,node:o,rect:c}=a;const[d,f]=O.useState(null),h=O.useRef(l);return hn(()=>{if(!i&&l!==h.current&&o.current){const m=c.current;if(m){const y=ea(o.current,{ignoreTransform:!0}),_={x:m.left-y.left,y:m.top-y.top,scaleX:m.width/y.width,scaleY:m.height/y.height};(_.x||_.y)&&f(_)}}l!==h.current&&(h.current=l)},[i,l,o,c]),O.useEffect(()=>{d&&f(null)},[d]),d}function D0(a){let{animateLayoutChanges:i=E0,attributes:l,disabled:o,data:c,getNewIndex:d=q0,id:f,strategy:h,resizeObserverConfig:m,transition:y=T0}=a;const{items:_,containerId:v,activeIndex:b,disabled:E,disableTransforms:k,sortedRects:A,overIndex:B,useDragOverlay:K,strategy:L}=O.useContext(ag),H=C0(o,E),V=_.indexOf(f),$=O.useMemo(()=>({sortable:{containerId:v,index:V,items:_},...c}),[v,c,V,_]),J=O.useMemo(()=>_.slice(_.indexOf(f)),[_,f]),{rect:z,node:U,isOver:Q,setNodeRef:P}=s0({id:f,data:$,disabled:H.droppable,resizeObserverConfig:{updateMeasurementsFor:J,...m}}),{active:F,activatorEvent:I,activeNodeRect:pe,attributes:Be,setNodeRef:Me,listeners:x,isDragging:Z,over:ie,setActivatorNodeRef:de,transform:ye}=t0({id:f,data:$,attributes:{...O0,...l},disabled:H.draggable}),w=H_(P,Me),R=!!F,W=R&&!k&&Lo(b)&&Lo(B),ee=!K&&Z,oe=ee&&W?ye:null,_e=W?oe??(h??L)({rects:A,activeNodeRect:pe,activeIndex:b,overIndex:B,index:V}):null,Ue=Lo(b)&&Lo(B)?d({id:f,items:_,activeIndex:b,overIndex:B}):V,Ee=F?.id,Ae=O.useRef({activeId:Ee,items:_,newIndex:Ue,containerId:v}),gn=_!==Ae.current.items,At=i({active:F,containerId:v,isDragging:Z,isSorting:R,id:f,index:V,items:_,newIndex:Ae.current.newIndex,previousItems:Ae.current.items,previousContainerId:Ae.current.containerId,transition:y,wasDragging:Ae.current.activeId!=null}),Bn=N0({disabled:!At,index:V,node:U,rect:z});return O.useEffect(()=>{R&&Ae.current.newIndex!==Ue&&(Ae.current.newIndex=Ue),v!==Ae.current.containerId&&(Ae.current.containerId=v),_!==Ae.current.items&&(Ae.current.items=_)},[R,Ue,v,_]),O.useEffect(()=>{if(Ee===Ae.current.activeId)return;if(Ee!=null&&Ae.current.activeId==null){Ae.current.activeId=Ee;return}const vn=setTimeout(()=>{Ae.current.activeId=Ee},50);return()=>clearTimeout(vn)},[Ee]),{active:F,activeIndex:b,attributes:Be,data:$,rect:z,index:V,newIndex:Ue,items:_,isOver:Q,isSorting:R,isDragging:Z,listeners:x,node:U,overIndex:B,over:ie,setNodeRef:w,setActivatorNodeRef:de,setDroppableNodeRef:P,setDraggableNodeRef:Me,transform:Bn??_e,transition:ot()};function ot(){if(Bn||gn&&Ae.current.newIndex===V)return B0;if(!(ee&&!dr(I)||!y)&&(R||At))return Ei.Transition.toString({...y,property:lg})}}function C0(a,i){var l,o;return typeof a=="boolean"?{draggable:a,droppable:!1}:{draggable:(l=a?.draggable)!=null?l:i.draggable,droppable:(o=a?.droppable)!=null?o:i.droppable}}function Wo(a){if(!a)return!1;const i=a.data.current;return!!(i&&"sortable"in i&&typeof i.sortable=="object"&&"containerId"in i.sortable&&"items"in i.sortable&&"index"in i.sortable)}const x0=[Se.Down,Se.Right,Se.Up,Se.Left],M0=(a,i)=>{let{context:{active:l,collisionRect:o,droppableRects:c,droppableContainers:d,over:f,scrollableAncestors:h}}=i;if(x0.includes(a.code)){if(a.preventDefault(),!l||!o)return;const m=[];d.getEnabled().forEach(v=>{if(!v||v!=null&&v.disabled)return;const b=c.get(v.id);if(b)switch(a.code){case Se.Down:o.top<b.top&&m.push(v);break;case Se.Up:o.top>b.top&&m.push(v);break;case Se.Left:o.left>b.left&&m.push(v);break;case Se.Right:o.left<b.left&&m.push(v);break}});const y=ab({collisionRect:o,droppableRects:c,droppableContainers:m});let _=Ly(y,"id");if(_===f?.id&&y.length>1&&(_=y[1].id),_!=null){const v=d.get(l.id),b=d.get(_),E=b?c.get(b.id):null,k=b?.node.current;if(k&&E&&v&&b){const B=fr(k).some((J,z)=>h[z]!==J),K=og(v,b),L=k0(v,b),H=B||!K?{x:0,y:0}:{x:L?o.width-E.width:0,y:L?o.height-E.height:0},V={x:E.left,y:E.top};return H.x&&H.y?V:ll(V,H)}}}};function og(a,i){return!Wo(a)||!Wo(i)?!1:a.data.current.sortable.containerId===i.data.current.sortable.containerId}function k0(a,i){return!Wo(a)||!Wo(i)||!og(a,i)?!1:a.data.current.sortable.index<i.data.current.sortable.index}function z0({value:a,rank:i,onRemove:l,isEntering:o,isExpanded:c,onToggleExpand:d}){const{attributes:f,listeners:h,setNodeRef:m,transform:y,transition:_,isDragging:v}=D0({id:a.id}),b={transform:Ei.Transform.toString(y),transition:_,opacity:v?.5:1},E=`priority-item${o?" entering":""}${c?" expanded":""}`,k=A=>{A.target.closest(".priority-handle, .priority-remove")||d(a.id)};return X.jsxs("div",{className:"priority-row",children:[X.jsx("span",{className:"rank-number",children:i}),X.jsxs("div",{className:"priority-item-wrapper",children:[X.jsxs("div",{ref:m,style:b,className:E,onClick:k,children:[X.jsx("span",{className:"priority-handle",...f,...h,children:"⋮⋮"}),X.jsx("span",{className:"priority-name",children:a.name}),X.jsx("button",{className:"priority-remove",onClick:()=>l(a.id),children:"×"})]}),X.jsx("div",{className:`priority-description${c?" visible":""}`,children:X.jsx("p",{children:a.description})})]})]})}function R0({availableValues:a,onAdd:i,rank:l}){const o=c=>{const d=c.target.value;if(d){const f=a.find(h=>h.id===d);f&&i(f)}};return X.jsxs("div",{className:"priority-row",children:[X.jsx("span",{className:"rank-number",children:l}),X.jsxs("div",{className:"priority-add",children:[X.jsx("span",{className:"add-icon",children:"+"}),X.jsxs("select",{className:"add-value-select",onChange:o,value:"",children:[X.jsx("option",{value:"",children:"Add a value…"}),a.map(c=>X.jsx("option",{value:c.id,children:c.name},c.id))]})]})]})}function j0({values:a,selectedPriorities:i,onSelectedPrioritiesChange:l,frameId:o,frames:c,onFrameChange:d}){const[f,h]=O.useState(null),[m,y]=O.useState(new Set),[_,v]=O.useState(null),b=O.useRef(void 0),E=tb(Yc(bd,{activationConstraint:{distance:8}}),Yc(Iy,{activationConstraint:{delay:200,tolerance:5}}),Yc(vd,{coordinateGetter:M0})),k=new Set(i.map(z=>z.id)),A=a.filter(z=>!k.has(z.id)),B=i.length<5;O.useEffect(()=>(m.size>0&&(b.current=window.setTimeout(()=>{y(new Set)},500)),()=>{b.current&&clearTimeout(b.current)}),[m]);const K=z=>{B&&(l([...i,z]),y(new Set([z.id])))},L=z=>{_===z&&v(null),l(i.filter(U=>U.id!==z))},H=z=>{v(_===z?null:z)},V=z=>{h(z.active.id),v(null)},$=z=>{const{active:U,over:Q}=z;if(h(null),Q&&U.id!==Q.id){const P=i.findIndex(I=>I.id===U.id),F=i.findIndex(I=>I.id===Q.id);l(Ad(i,P,F))}},J=i.find(z=>z.id===f);return X.jsx("div",{className:"priorities-tab",children:X.jsxs("div",{className:"priorities-panel",children:[X.jsx("h2",{children:"What matters the most?"}),X.jsx("p",{className:"instructions",children:"Choose up to five values that matter most to you."}),X.jsxs("div",{className:"frame-selector",children:[X.jsx("label",{htmlFor:"frame-select",children:"Values for:"}),X.jsx("select",{id:"frame-select",className:"frame-select",value:o,onChange:z=>d(z.target.value),children:c.map(z=>X.jsx("option",{value:z.id,children:z.name},z.id))})]}),X.jsxs(Wb,{sensors:E,collisionDetection:sb,onDragStart:V,onDragEnd:$,children:[X.jsx(w0,{items:i.map(z=>z.id),strategy:S0,children:X.jsxs("div",{className:"priorities-list",children:[i.map((z,U)=>X.jsx(z0,{value:z,rank:U+1,onRemove:L,isEntering:m.has(z.id),isExpanded:_===z.id,onToggleExpand:H},z.id)),B&&A.length>0&&X.jsx(R0,{availableValues:A,onAdd:K,rank:i.length+1})]})}),X.jsx(g0,{children:J?X.jsxs("div",{className:"priority-item dragging drag-overlay",children:[X.jsx("span",{className:"priority-handle",children:"⋮⋮"}),X.jsx("span",{className:"priority-name",children:J.name})]}):null})]})]})})}const rg=`questions:
  - id: q1
  ...
  - id: a20
    ...
    impactB:
      asimov-third: 1
      asimov-second: -1
`;function U0({surveyId:a,defaultSurvey:i,frameId:l,answers:o,onAnswersChange:c}){const[d,f]=O.useState([]);O.useEffect(()=>{const v=En(rg);let b=v.questions.filter(E=>E.survey_id===a).sort((E,k)=>E.survey_order-k.survey_order);b.length===0&&a!==i&&(b=v.questions.filter(E=>E.survey_id===i).sort((E,k)=>E.survey_order-k.survey_order)),f(b)},[a,i]);const h=(v,b)=>{c({...o,[v]:o[v]===b?null:b})};if(d.length===0)return X.jsx("div",{className:"questions-tab",children:X.jsx("div",{className:"questions-panel",children:X.jsx("p",{className:"placeholder",children:"No questions available for this survey."})})});const y=`${l.charAt(0).toUpperCase()+l.slice(1)} Scenarios`,_=d.filter(v=>o[v.id]==="A"||o[v.id]==="B").length;return X.jsx("div",{className:"questions-tab",children:X.jsxs("div",{className:"questions-panel",children:[X.jsx("h2",{children:y}),X.jsx("p",{className:"instructions",children:"For each scenario, choose the option that best reflects how you would respond."}),X.jsxs("p",{className:"questions-progress",children:[_," of ",d.length," answered"]}),X.jsx("div",{className:"questions-list",children:d.map((v,b)=>X.jsxs("div",{className:"question-card",children:[X.jsx("div",{className:"question-number",children:b+1}),X.jsxs("div",{className:"question-content",children:[X.jsx("p",{className:"question-context",children:v.context}),X.jsxs("div",{className:"question-options",children:[X.jsxs("button",{className:`option-button ${o[v.id]==="A"?"selected":""}`,onClick:()=>h(v.id,"A"),children:[X.jsx("span",{className:"option-label",children:"A"}),X.jsx("span",{className:"option-text",children:v.optionA})]}),X.jsxs("button",{className:`option-button ${o[v.id]==="B"?"selected":""}`,onClick:()=>h(v.id,"B"),children:[X.jsx("span",{className:"option-label",children:"B"}),X.jsx("span",{className:"option-text",children:v.optionB})]})]})]})]},v.id))})]})})}const ug=`surveys:
  - id: workplace-survey
    frame_id: workplace
    is_paid: false
...
`,G0=`known_models:
  ...
  - id: llama-4
    ...
    vendor: Meta
    version: "4"
`;function $m(a,i){switch(a.type){case"known_model":{if(a.model_name)return a.model_name;const l=i.find(o=>o.id===a.model_id);return l?l.name:a.model_id||"Unknown Model"}case"custom_model":return a.model_name||"Custom Model";case"person":return`${a.first_name} ${a.last_name}`;default:return"Unknown"}}function K0({selectedPriorities:a,frameId:i}){const[l,o]=O.useState([]),[c,d]=O.useState([]),[f,h]=O.useState([]),[m,y]=O.useState([]),[_,v]=O.useState([]),[b,E]=O.useState([]),[k,A]=O.useState("");O.useEffect(()=>{const Q=En(ug);o(Q.surveys);const P=En(rg);d(P.questions);const F=En(L0);h(F.respondents);const I=En(Y0);y(I.response_sets);const pe=En(H0);v(pe.responses);const Be=En(G0);E(Be.known_models)},[]);const B=O.useMemo(()=>l.find(P=>P.frame_id===i)?.id||null,[l,i]);O.useEffect(()=>{A("")},[i]);const K=O.useMemo(()=>{if(!B)return[];const Q=new Set(_.map(F=>F.response_set_id)),P=new Set(m.filter(F=>F.survey_id===B&&Q.has(F.id)).map(F=>F.respondent_id));return f.filter(F=>F.type!=="person"&&P.has(F.id))},[f,m,_,B]),L=O.useMemo(()=>{if(!k||!B)return null;const Q=m.filter(P=>P.respondent_id===k&&P.survey_id===B);return Q.length===0?null:Q.sort((P,F)=>new Date(F.timestamp).getTime()-new Date(P.timestamp).getTime())[0]},[k,m,B]),H=O.useMemo(()=>{if(!L)return{};const Q=_.filter(F=>F.response_set_id===L.id),P={};return Q.forEach(F=>{P[F.question_id]=F.value}),P},[L,_]),V=O.useMemo(()=>{const Q={};return a.forEach((P,F)=>{Q[P.id]=F+1}),Q},[a]),$=O.useMemo(()=>{const Q=new Set(a.map(I=>I.id)),P=new Set,F={};return c.forEach(I=>{const pe=H[I.id];if(!pe)return;const Be=pe==="A"?I.impactA:I.impactB;if(!Be)return;const Me={};Object.entries(Be).forEach(([Z,ie])=>{Q.has(Z)&&(Me[Z]=ie)});const x=Object.keys(Me);for(let Z=0;Z<x.length;Z++)for(let ie=Z+1;ie<x.length;ie++){const[de,ye]=[x[Z],x[ie]].sort(),w=`${de}|${ye}`,R=Me[de]||0,W=Me[ye]||0,ee=R-W;ee!==0&&(F[w]||(F[w]=[]),F[w].push(ee))}}),Object.entries(F).forEach(([I,pe])=>{const Be=pe.some(x=>x>0),Me=pe.some(x=>x<0);if(Be&&Me){const[x,Z]=I.split("|");P.add(x),P.add(Z)}}),P},[a,H,c]),J=O.useMemo(()=>{const Q={};a.forEach(I=>{Q[I.id]=0}),c.forEach(I=>{const pe=H[I.id];if(!pe)return;const Be=pe==="A"?I.impactA:I.impactB;Be&&Object.entries(Be).forEach(([Me,x])=>{Me in Q&&(Q[Me]+=x)})});const P=a.map(I=>({value:I,score:Q[I.id],rank:0,originalRank:V[I.id],rankDiff:0,isTied:!1,isConflicted:$.has(I.id)}));P.sort((I,pe)=>pe.score-I.score);let F=1;for(let I=0;I<P.length;I++)I>0&&P[I].score===P[I-1].score?(P[I].rank=P[I-1].rank,P[I].isTied=!0,P[I-1].isTied=!0):P[I].rank=F,P[I].rankDiff=P[I].originalRank-P[I].rank,F++;return P},[a,H,c,V,$]),z=f.find(Q=>Q.id===k),U=z?$m(z,b):null;return a.length===0?X.jsx("div",{className:"comparison-tab",children:X.jsx("div",{className:"comparison-panel",children:X.jsx("p",{className:"placeholder",children:"Select some priorities first to see how your answers compare."})})}):X.jsx("div",{className:"comparison-tab",children:X.jsxs("div",{className:"comparison-panel",children:[X.jsx("h2",{children:"Their priorities"}),X.jsxs("div",{className:"respondent-selector",children:[X.jsx("label",{htmlFor:"respondent-select",children:"Compare with:"}),X.jsxs("select",{id:"respondent-select",value:k,onChange:Q=>A(Q.target.value),className:"respondent-select",children:[X.jsx("option",{value:"",children:"Select a respondent..."}),K.map(Q=>X.jsx("option",{value:Q.id,children:$m(Q,b)},Q.id))]})]}),X.jsxs("div",{className:"comparison-lists",children:[X.jsxs("div",{className:"comparison-column",children:[X.jsx("h3",{children:"Your priorities"}),X.jsx("div",{className:"comparison-items",children:a.map((Q,P)=>X.jsxs("div",{className:"comparison-item original",children:[X.jsx("span",{className:"comparison-rank",children:P+1}),X.jsx("span",{className:"comparison-name",children:Q.name})]},Q.id))})]}),X.jsxs("div",{className:"comparison-column",children:[X.jsx("h3",{children:U?`${U}'s priorities`:"Their priorities"}),k?L?X.jsx("div",{className:"comparison-items",children:J.map(Q=>X.jsxs("div",{className:`comparison-item reordered ${Q.isTied?"tied":""}`,children:[X.jsx("span",{className:`comparison-rank ${Q.isTied?"tied":""}`,children:Q.isTied?`=${Q.rank}`:Q.rank}),X.jsx("span",{className:"comparison-name",children:Q.value.name}),X.jsxs("div",{className:"comparison-badges",children:[Q.rankDiff!==0&&X.jsxs("span",{className:`comparison-diff ${Q.rankDiff>0?"positive":"negative"}`,children:[Q.rankDiff>0?"+":"",Q.rankDiff]}),Q.isConflicted&&X.jsx("span",{className:"comparison-conflicted",children:"conflicted"})]})]},Q.value.id))}):X.jsx("p",{className:"comparison-empty",children:"No responses found for this respondent"}):X.jsx("p",{className:"comparison-empty",children:"Select a respondent to see comparison"})]})]}),X.jsxs("div",{className:"comparison-unified",children:[a.map((Q,P)=>{const F=J.find(pe=>pe.value.id===Q.id),I=!!(k&&L&&F);return X.jsxs("div",{className:`unified-item${I&&F.isTied?" tied":""}`,children:[X.jsx("span",{className:"unified-your-rank",children:P+1}),X.jsx("span",{className:"unified-name",children:Q.name}),I&&F?X.jsxs(X.Fragment,{children:[X.jsx("span",{className:"unified-arrow",children:"→"}),X.jsx("span",{className:`unified-their-rank${F.isTied?" tied":""}`,children:F.isTied?`=${F.rank}`:F.rank}),F.rankDiff!==0&&X.jsxs("span",{className:`unified-diff ${F.rankDiff>0?"positive":"negative"}`,children:[F.rankDiff>0?"+":"",F.rankDiff]})]}):null]},Q.id)}),!k&&X.jsx("p",{className:"comparison-empty",children:"Select a respondent above to compare"}),k&&!L&&X.jsx("p",{className:"comparison-empty",children:"No responses found for this respondent"})]})]})})}const X0=`values:
  - id: integrity
    frame_id: workplace
    name: Integrity
...
`,V0="workplace",cg="default-survey";function Z0(a){return a.length===0?cg:`survey-${a.map(l=>l.id).sort().join("-")}`}function J0(){const[a,i]=O.useState("priorities"),[l,o]=O.useState([]),[c,d]=O.useState([]),[f,h]=O.useState([]),[m,y]=O.useState([]),[_,v]=O.useState(V0),b=O.useMemo(()=>l.filter(L=>L.frame_id===_),[l,_]),E=O.useMemo(()=>f.find(H=>H.frame_id===_)?.id||cg,[f,_]),k=O.useMemo(()=>Z0(m),[m]),[A,B]=O.useState({});O.useEffect(()=>{const L=En(X0);o(L.values);const H=En(Q0);d(H.frames);const V=En(ug);h(V.surveys)},[]);const K=L=>{v(L),B({});const H=l.filter(V=>V.frame_id===L);H.length<=3?y(H):y([])};return X.jsxs("div",{className:"app",children:[X.jsxs("header",{className:"header",children:[X.jsx("a",{href:"https://longreach.ai",target:"_blank",rel:"noopener noreferrer",className:"header-logo-link",children:X.jsx("img",{src:"/logo.png",alt:"Longreach",className:"header-logo"})}),X.jsx("h1",{children:"Priorities"})]}),X.jsxs("nav",{className:"tabs",children:[X.jsxs("button",{className:a==="priorities"?"active":"",onClick:()=>i("priorities"),children:[X.jsx("span",{className:"tab-step",children:"1"}),"Priorities"]}),X.jsxs("button",{className:a==="questions"?"active":"",onClick:()=>i("questions"),children:[X.jsx("span",{className:"tab-step",children:"2"}),"Questions"]}),X.jsxs("button",{className:a==="comparison"?"active":"",onClick:()=>i("comparison"),children:[X.jsx("span",{className:"tab-step",children:"3"}),"Comparison"]})]}),X.jsxs("main",{className:"content",children:[a==="priorities"&&X.jsx(j0,{values:b,selectedPriorities:m,onSelectedPrioritiesChange:y,frameId:_,frames:c,onFrameChange:K}),a==="questions"&&X.jsx(U0,{surveyId:k,defaultSurvey:E,frameId:_,answers:A,onAnswersChange:B}),a==="comparison"&&X.jsx(K0,{selectedPriorities:m,frameId:_})]})]})}C1.createRoot(document.getElementById("root")).render(X.jsx(O.StrictMode,{children:X.jsx(J0,{})}));
